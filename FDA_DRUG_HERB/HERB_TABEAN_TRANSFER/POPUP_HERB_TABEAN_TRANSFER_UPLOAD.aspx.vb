Public Class POPUP_HERB_TABEAN_TRANSFER_UPLOAD
    ...
    Public Sub BindTable()
        ...
        Dim dao_sub As New DAO_TABEAN_HERB.TB_TABEAN_TRANSFER
    ...
    Sub alert_normal(ByVal text As String)
        Dim url As String = ""
        url = "FRM_HERB_TABEAN_TRANSFER.aspx?PROCESS_ID=" & _PROCESS_ID & "&IDA=" & _IDA
    ...
    Sub alert_file_error(ByVal text As String)
        Dim url As String = ""
        url = "POPUP_HERB_TABEAN_TRANSFER_UPLOAD.aspx?PROCESS_ID=" & _PROCESS_ID & "&IDA=" & _IDA
