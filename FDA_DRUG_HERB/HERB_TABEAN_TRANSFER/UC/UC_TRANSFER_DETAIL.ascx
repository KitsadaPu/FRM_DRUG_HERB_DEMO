<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UC_TRANSFER_DETAIL.ascx.vb" Inherits="FDA_DRUG_HERB.UC_TRANSFER_DETAIL" %>
...
<div runat="server" id="head_tabean">
    <div class="row">
        <div class="col-lg-1"></div>
        <div class="col-lg-10">
            <h3 style="text-align: center">คำขอทะเบียนตำรับผลิตภัณฑ์สมุนไพร(transfer)</h3>
        </div>
        <div class="col-lg-1"></div>
    </div>
    <div class="row">
        ...
        <div class="col-lg-4" style="border-bottom: #999999 1px dotted; text-align: center">
            <asp:TextBox ID="NAME_TB" runat="server" Width="90%" BorderStyle="None" ReadOnly="true"></asp:TextBox>
        </div>
        <div class="col-lg-1">
            <label>ชื่อสถานที่:</label>
        </div>
        <div class="col-lg-2" style="border-bottom: #999999 1px dotted">
            <asp:TextBox ID="NAME_PLACE_TB" runat="server" ReadOnly="true"  BorderStyle="None" Width="100%"></asp:TextBox>
        </div>
        <div class="col-lg-1"></div>
    </div>
 ...
 <%--       <div class="col-lg-2">
    ...
    <div class="row">
        ...
        <div class="col-lg-1" style="border-bottom: #999999 1px dotted;">
            <asp:TextBox ID="txt_person_age" runat="server" TextMode="Number" BorderStyle="None" Width="100%"></asp:TextBox>
        </div>
...
<%--        <div class="col-lg-2">
    ...
    <div id="STAFF_KEY_SET" runat="server" visible="false">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <asp:TextBox ID="NO_ID" runat="server" Width="100%" TextMode="Number" ReadOnly="true"></asp:TextBox>
            </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-8" style="border-bottom: #999999 1px dotted">
            <asp:TextBox ID="PROPERTIES" runat="server" TextMode="MultiLine" Height="60px" Width="100%" ReadOnly="true"></asp:TextBox>
        </div>
        <div class="col-lg-1"></div>
    </div>
    <div class="row">
        ...
        <div class="col-lg-8" style="border-bottom: #999999 1px dotted">
            <asp:TextBox ID="SIZE_USE" runat="server" TextMode="MultiLine" Height="60px" Width="100%" ReadOnly="true"></asp:TextBox>
        </div>
        <div class="col-lg-1"></div>
    </div>
    <div class="row">
        ...
        <div class="col-lg-2" style="border-bottom: #999999 1px dotted">
            <asp:TextBox ID="HOW_USE" runat="server"  BorderStyle="None" ReadOnly="true"></asp:TextBox>
        </div>
        <div class="col-lg-2">
    ...
    <div class="row">
        ...
        <div class="col-lg-6" id="R_WARNING_TYPE_TEXT" runat="server" visible="false">
            <asp:TextBox ID="WARNING_TYPE_NAME" runat="server" TextMode="MultiLine" Height="60px" Width="100%" ReadOnly="true"></asp:TextBox>
        </div>
        <div class="col-lg-1"></div>
    </div>
    <div class="row">
        ...
        <div class="col-lg-2" style="border-bottom: #999999 1px dotted">
            <asp:DropDownList ID="DD_WARNING" runat="server" DataValueField="PRO_WARNING_MAIN_ID" DataTextField="PRO_WARNING_MAIN_NAME" BackColor="White" Height="25px" Width="100%" SkinID="bootstrap" Visible="false" AutoPostBack="true"  Enabled="false"></asp:DropDownList>
        </div>
        <div class="col-lg-2">
...
<%--    <hr />
    ...
    <div class="row">
        ...
        <div class="col-lg-4" style="border-bottom: #999999 1px dotted">
            <asp:TextBox ID="RECIPE_NAME" runat="server" TextMode="singleline" BorderStyle="None" Height="20px" Width="100%" ReadOnly="true"></asp:TextBox>
        </div>
        <div class="col-lg-2">
            <asp:DropDownList ID="DDL_RECIPE_NAME" runat="server" BackColor="White" Height="25px" Width="200px" SkinID="bootstrap"  Enabled="false">
                <asp:ListItem Value="0">-- กรุณาเลือก --</asp:ListItem>
