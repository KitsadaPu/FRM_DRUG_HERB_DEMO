        ...
        <div class="col-lg-4" style="width: 30%">
            ...
            <div class="row" runat="server" id="p2" visible="false">
                ...
                <div class="row" runat="server">
                    <div class="col-lg-1"></div>
                    <div class="col-lg-4">
                        <asp:Label ID="Label1" runat="server" Text="เจ้าหน้าที่" Font-Size="Large"></asp:Label><asp:Label ID="NAME_ST" runat="server" Text="" Font-Size="Large"></asp:Label>
                    </div>
                    <div class="col-lg-6">
                        <asp:TextBox ID="STAFF_NAME" TextMode="MultiLine" runat="server" Style="height: 20%; width: 100%" ReadOnly="true"></asp:TextBox>
                    </div>
                    <div class="col-lg-1"></div>
                </div>
                <%--  <div class="row">
