Public Class POPUP_TABEAN_SUBSTITUTE_UPLOAD
    ...
    Protected Sub btn_add_upload_Click(sender As Object, e As EventArgs) Handles btn_add_upload.Click
        ...
        Else
            ...
            'dao_pdftemplate.GETDATA_TABEAN_HERB_JJ_TEMPLAETE1(_PROCESS_ID, dao.fields.STATUS_ID, "จจ1", 0)
    ...
    Sub alert_normal(ByVal text As String)
        Dim url As String = ""
        url = "FRM_TABEAN_SUBSTITUTE_SUB_DR.aspx?IDA_LCT=" & _IDA_LCT & "&IDA_LCN=" & _IDA_LCN & "&PROCESS_ID=" & _PROCESS_ID & "&IDA=" & _IDA & "&SID=" & _SID
