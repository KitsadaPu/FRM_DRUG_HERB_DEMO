...
Public Class POPUP_SEARCH_TABEAN_DETAIL
    ...
    Private Sub RG_EDIT_ItemDataBound(sender As Object, e As GridItemEventArgs) Handles RG_EDIT.ItemDataBound
        If e.Item.ItemType = GridItemType.AlternatingItem Or e.Item.ItemType = GridItemType.Item Then
            ...
            H.Target = "_blank"
            If _ProcessID = "1400001" Then
                H.NavigateUrl = "../HERB_SEARCH_TABEAN/POPUP_TABEAN_LOG_EDIT_DETAIL.aspx?ida=" & IDA & "&PROCESS_ID=" & PROCESS_ID
            Else
                H.NavigateUrl = "../HERB_SEARCH_TABEAN/POPUP_TABEAN_LOG_EDIT_DETAIL.aspx?ida=" & IDA & "&PROCESS_ID=" & PROCESS_ID
            End If
    ...
    Function bind_data_log_tabean_edit()
        ...
        ProcessID = dao_G.fields.PROCESS_ID
        If ProcessID = "1400001" Then
            dt = bao.SP_DRRGT_LOG_EDIT_DETAIL_BY_IDA_G(_IDA_G)
        Else
    ...
    Private Sub BindData_PDF_SAI(ByVal newcode As String)
        ...
        lr_preview.Text = "<iframe id='iframe1'  style='height:850px;width:100%;' src='../PDF/FRM_PDF.aspx?FileName=" & filename & "' ></iframe>"
