...
Imports System.IO
    ...
    Public Class POPUP_HERB_REPORT_MATERIAL_UPLOAD
        ...
        Dim dao_inform As New DAO_REPORT.TB_HERB_PRODUCT_REPORT
        ...
        Sub alert_normal(ByVal text As String)
            Dim url As String = ""
        url = "FRM_HERB_REPORT_MATERIAL.aspx?MENU_GROUP=" & _MENU_GROUP & "&IDA_LCN=" & _IDA_LCN & "&PROCESS_ID_LCN=" & _PROCESS_ID_LCN & "&IDA_DQ=" & _IDA & "&PROCESS_ID_DQ=" & _PROCESS_ID & "&staff=" & Request.QueryString("staff") & "&SID=" & _SID
        ...
        Sub alert_file_error(ByVal text As String)
            Dim url As String = ""
        url = "POPUP_HERB_REPORT_MATERIAL_UPLOAD.aspx?MENU_GROUP=" & _MENU_GROUP & "&IDA_LCN=" & _IDA_LCN & "&PROCESS_ID_LCN=" & _PROCESS_ID_LCN & "&IDA_DQ=" & _IDA & "&PROCESS_ID_DQ=" & _PROCESS_ID
        Response.Write("<script type='text/javascript'>alert('" + text + "');window.location='" & url & "';</script> ")
        End Sub
