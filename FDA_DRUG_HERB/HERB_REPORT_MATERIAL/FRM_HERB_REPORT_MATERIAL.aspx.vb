...
Public Class FRM_HERB_REPORT_MATERIAL
    ...
    Protected Sub btn_tb_herb_Click(sender As Object, e As EventArgs) Handles btn_tb_herb.Click
        ...
        If Request.QueryString("staff") = 1 Then
            _MENU_GROUP = 1
            System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups('" & " POPUP_HERB_REPORT_MATERIAL_ADD.aspx?IDA_LCN=" & _IDA_LCN & "&PROCESS_ID_LCN=" & _PROCESS_ID_LCN & "&PROCESS_ID=" & _PROCESS_ID & "&IDA=" & dao.fields.IDA & "&staff=" & Request.QueryString("staff") & "&SID=" & _SID & "');", True)
        Else
            System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups('" & " POPUP_HERB_REPORT_MATERIAL_ADD.aspx?IDA_LCN=" & _IDA_LCN & "&PROCESS_ID_LCN=" & _PROCESS_ID_LCN & "&PROCESS_ID=" & _PROCESS_ID & "&IDA=" & dao.fields.IDA & "&SID=" & _SID & "');", True)
        End If
    End Sub
    ...
    Function bind_data()
        ...
        'Else
        dt = bao.SP_HERB_REPORT_MAIN_BY_FK_IDA_LCN(_IDA_LCN, _CLS.CITIZEN_ID_AUTHORIZE, _PROCESS_ID)
        'End If
    ...
    Private Sub RadGrid1_ItemCommand(sender As Object, e As GridCommandEventArgs) Handles RadGrid1.ItemCommand
        If TypeOf e.Item Is GridDataItem Then
            ...
            If e.CommandName = "HL_SELECT" Then
                System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups('" & "../HERB_REPORT_MATERIAL/POPUP_HERB_REPORT_MATERIAL_CONFIRM.aspx?IDA_LCN=" & IDA_LCN & "&IDA=" & IDA & "&PROCESS_ID=" & _PROCESS_ID & "&TR_ID=" & TR_ID & "&staff=" & Request.QueryString("staff") & "');", True)
            End If
