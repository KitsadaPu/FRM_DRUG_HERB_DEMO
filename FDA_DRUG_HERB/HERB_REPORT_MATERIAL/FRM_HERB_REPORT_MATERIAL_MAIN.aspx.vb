Public Class FRM_HERB_REPORT_MATERIAL_MAIN
    ...
    Private Sub RunQuery()
        ...
        '_TOKEN = "hB0X6fbAQFzKt3TH4Y2ymQUU"
    End Sub
    ...
    Sub token()
        ...
        If code = "900" Then
            ...
            If _CLS.SYSTEM_ID = "8738" Or _CLS.SYSTEM_ID = "8734" Or _CLS.SYSTEM_ID = "9816" Then
                ...
                Response.Redirect("../HERB_REPORT_MATERIAL/FRM_HERB_REPORT_MATERIAL_MAIN_MENU.aspx")
            Else
                _CLS.ID_MENU = 1200
                Session("CLS") = _CLS
                Response.Redirect("../HERB_REPORT_MATERIAL/FRM_HERB_REPORT_MATERIAL_MAIN_MENU.aspx")
