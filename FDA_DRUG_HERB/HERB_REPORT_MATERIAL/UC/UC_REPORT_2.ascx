<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UC_REPORT_2.ascx.vb" Inherits="FDA_DRUG_HERB.UC_REPORT_2" %>
...
<div class="row">
    ...
    <div class="col-lg-2">
        เลขที่ใบสำคัญการขึ้นทะเบียนตำรับใบรับแจ้งรายละเอียดหรือใบรับจดแจ้งผลิตภัณฑ์สมุนไพร
    </div>
      <div class="col-lg-2">
            ...
            <MasterTableView AutoGenerateColumns="False" DataKeyNames="IDA">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="Voucher_Number" FilterControlAltText="Filter Voucher_Number column"
                        HeaderText="เลขที่ใบสำคัญการขึ้นทะเบียนตำรับใบรับแจ้งรายละเอียดหรือใบรับจดแจ้งผลิตภัณฑ์สมุนไพร" SortExpression="Voucher_Number" UniqueName="Voucher_Number">
                    </telerik:GridBoundColumn> 
                    ...
                    <telerik:GridBoundColumn DataField="Sale_Unit" FilterControlAltText="Filter Sale_Unit column"
                        HeaderText="มูลค่าที่ขายจากโรงงานต่อหน่วย" SortExpression="Sale_Unit" UniqueName="Sale_Unit">
                    </telerik:GridBoundColumn>
