...
Public Class POPUP_TABEAN_HERB_ANALYZE_STAFF_EDIT
    ...
    Sub Blind_PDF()
        ...
        dao_pdftemplate.GETDATA_TABEAN_HERB_JJ_TEMPLAETE1(_ProcessID, dao.fields.STATUS_ID, "วค1", 0)
    ...
    Function bind_data_uploadfile()
        ...
        End If
        dt = bao.SP_MAS_TABEAN_HERB_UPLOADFILE_BY_TYPE(209)
    ...
    Protected Sub btn_add_upload_Click(sender As Object, e As EventArgs) Handles btn_add_upload.Click
        ...
        Else
            ...
            Dim path As String = System.Configuration.ConfigurationManager.AppSettings("PATH_XML_PDF_TABEAN_ANALYZE")
    ...
    Function bind_data_uploadfile_1()
        ...
        'dt = bao.SP_TABEAN_HERB_UPLOAD_FILE_JJ_FK_IDA_LCN(_TR_ID, 1, _ProcessID, dao.fields.FK_LCN)
    ...
    Private Sub RadGrid3_ItemDataBound(sender As Object, e As GridItemEventArgs) Handles RadGrid3.ItemDataBound
        If e.Item.ItemType = GridItemType.AlternatingItem Or e.Item.ItemType = GridItemType.Item Then
            ...
            H.Target = "_blank"
            H.NavigateUrl = "../HERB_TABEAN_ANALYZE/FRM_TABEAN_HERB_ANALYZE_PREVIEW.aspx?ida=" & IDA
