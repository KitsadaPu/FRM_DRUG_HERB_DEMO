...
Public Class POPUP_TABEAN_HERB_ANALYZE_CONFIRM_STAFF
    ...
    Protected Sub btn_sumit_Click(sender As Object, e As EventArgs) Handles btn_sumit.Click
        ...
        If dao.fields.STATUS_ID = 3 Or dao.fields.STATUS_ID = 12 Then
        ...
        ElseIf dao.fields.STATUS_ID = 11 Then
            ...
            Response.Redirect("POPUP_TABEAN_HERB_ANALYZE_STAFF_EDIT.aspx?IDA=" & _IDA & "&process_id=" & _Process_ID & "&IDA_LCN=" & _IDA_LCN & "&TR_ID=" & _TR_ID)
