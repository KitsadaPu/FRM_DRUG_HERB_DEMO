<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_HERB_TABEAN_INFORM_EDIT_CONFIRM.aspx.vb" Inherits="FDA_DRUG_HERB.POPUP_HERB_TABEAN_INFORM_EDIT_CONFIRM" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-lg-8" style="width: 70%">
            <%--<iframe id="f1" style="width: 100%; height: 550px;"><a href="../PDF/INFORM_EDIT.pdf"></a> </iframe>--%>
            <%-- <a href="../PDF/INFORM_EDIT.pdf">../PDF/INFORM_EDIT.pdf</a>--%>
