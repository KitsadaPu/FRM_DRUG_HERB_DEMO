<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Main_Product.Master" CodeBehind="FRM_HERB_TABEAN_INFORM_EDIT.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_HERB_TABEAN_INFORM_EDIT" %>
...
<%--    <div class="row" style="text-align: center">
    ...
    <div class="row" runat="server" id="TH1">
        ...
        <div class="col-lg-2" style="width: 20%; text-align: right" >
            <asp:Button ID="btn_tb_herb" runat="server" Text="เพิ่มคำขอทะเบียนแก้ไขรับแจ้ง" Height="53px" />
        </div>
    <%--    <div class="col-lg-1"></div>--%>
    </div>
    <hr />
    <div class="row" id="T1" runat="server">
        ...
        <p class="h3">ข้อมูลทะเบียนแก้ไขแจ้งรายละเอียด</p>
        <hr />
