...
Public Class POPUP_HERB_TABEAN_INFORM_EDIT_UPLOAD
    ...
    Protected Sub btn_add_upload_Click(sender As Object, e As EventArgs) Handles btn_add_upload.Click
        ...
        'Dim dao As New DAO_TABEAN_HERB.TB_TABEAN_INFORM_EDIT_DETAIL
        ...
        alert("แนบไฟล์เรียบร้อยแล้ว กรุณากดดูรายละเอียดเพื่อยื่นคำขอ")
    ...
    Sub alert_normal(ByVal text As String)
        Dim url As String = ""
        url = "FRM_HERB_TABEAN_INFORM_EDIT.aspx?MENU_GROUP=" & _MENU_GROUP & "&IDA_LCN=" & _IDA_LCN & "&PROCESS_ID_LCN=" & _PROCESS_ID_LCN & "&IDA_DQ=" & _IDA & "&PROCESS_ID_DQ=" & _PROCESS_ID & "&staff=" & Request.QueryString("staff") & "&SID=" & _SID
    ...
    Sub alert_file_error(ByVal text As String)
        Dim url As String = ""
        url = "POPUP_HERB_TABEAN_INFORM_EDIT_UPLOAD.aspx?MENU_GROUP=" & _MENU_GROUP & "&IDA_LCN=" & _IDA_LCN & "&PROCESS_ID_LCN=" & _PROCESS_ID_LCN & "&IDA_DQ=" & _IDA & "&PROCESS_ID_DQ=" & _PROCESS_ID
        Response.Write("<script type='text/javascript'>alert('" + text + "');window.location='" & url & "';</script> ")
    End Sub
