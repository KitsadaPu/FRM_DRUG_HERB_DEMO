Public Class MAIN_HERB_CUSTOMER
        ...
        If gg <> "" Then
            ...
            If str_all = "" Then
                If _CLS.BTN_GROUPS = 1 Then
                    str_all = "<h2 class='text-center'><strong>" & "ระบบสร้างคำขอทะเบียน" & "</strong></h2>"

                Else
                    str_all = "<h2 class='text-center'><strong>" & "คำขออื่นๆ" & "</strong></h2>"
