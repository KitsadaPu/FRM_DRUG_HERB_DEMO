...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel" style="text-align: left; width: 100%">
        <div class="panel-heading panel-title" style="height: 70px">
            ...
            <div class="col-lg-4 col-md-4">
                <h4>สถานที่ขาย สถานที่นำหรือสั่งฯ/สถานที่ผลิต&nbsp;</h4>
            </div>
    ...
    <div class="panel panel-body" style="width: 95%; padding-left: 1%;">
        ...
        <telerik:RadGrid ID="RadGrid1" runat="server" AllowPaging="true" PageSize="10" AllowFilteringByColumn="True" Width="100%">
            <MasterTableView AutoGenerateColumns="False" DataKeyNames="IDA">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="SENT_DATE" DataFormatString="{0:d}" DataType="System.DateTime" FilterControlAltText="Filter SENT_DATE column" HeaderText="วันที่ส่งเรื่อง" SortExpression="SENT_DATE" UniqueName="SENT_DATE">
                        <ColumnValidationSettings>
                            <%--<ModelErrorMessage Text="" />--%>
                        </ColumnValidationSettings>
                    </telerik:GridBoundColumn>
        ...
        <div class="panel" style="text-align: left; width: 100%">
            <div class="panel-heading panel-title" style="height: 70px">
                ...
                <div class="col-lg-4 col-md-4">
                    <h4>สถานที่เก็บยาสำหรับใช้ประกอบสถานที่ขาย สถานที่นำหรือสั่งฯ/สถานที่ผลิต</h4>
                </div>
                <div class="col-lg-8 col-md-8">
                    <p style="text-align: right; padding-right: 5%;">
        ...
        <telerik:RadGrid ID="RadGrid2" runat="server" AllowPaging="true" PageSize="10" AllowFilteringByColumn="True" Width="100%">
            <MasterTableView AutoGenerateColumns="False" DataKeyNames="IDA">
                <CommandItemSettings ExportToPdfText="Export to PDF"></CommandItemSettings>
