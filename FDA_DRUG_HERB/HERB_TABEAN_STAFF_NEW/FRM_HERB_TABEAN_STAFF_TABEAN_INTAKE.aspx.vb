...
Public Class FRM_HERB_TABEAN_STAFF_TABEAN_INTAKE
    ...
    Function bind_data_uploadfile()
        ...
        dt = bao.SP_TABEAN_HERB_UPLOAD_FILE_JJ(dao_deeqt.fields.TR_ID, 7, _ProcessID, Request.QueryString("IDA"))
    ...
    Function bind_data_uploadfile_edit()
        ...
        dt = bao.SP_TABEAN_HERB_UPLOAD_FILE_JJ(dao_deeqt.fields.TR_ID, 10, _ProcessID, Request.QueryString("IDA"))
    ...
    Protected Sub btn_sumit_Click(sender As Object, e As EventArgs) Handles btn_sumit.Click
        ...
        Else
            ...
            ElseIf DD_STATUS.SelectedValue = 4 Then
                ...
                '    dao_tabean_herb.fields.STATUS_ID = DD_STATUS.SelectedValue
                '    dao_tabean_herb.Update()
            ElseIf DD_STATUS.SelectedValue = 18 Or DD_STATUS.SelectedValue = 77 Then
