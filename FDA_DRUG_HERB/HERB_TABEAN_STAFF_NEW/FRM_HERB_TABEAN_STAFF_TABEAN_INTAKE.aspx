    ...
    <div class="row">
        ...
        <div class="col-lg-4" style="width: 30%">
            ...
            <div class="row" runat="server" id="P15" visible="false">
                ...
                <div class="col-lg-6">
                    <asp:DropDownList ID="ddl_rgttpcd" runat="server" Width="100%">
                    </asp:DropDownList>
            ...
            <div class="row" runat="server" id="P12" visible="false">
                ...
                <div class="row" runat="server">
                    ...
                    <div class="col-lg-6">
                        ...
                        <asp:DropDownList ID="DD_OFF_REQ" runat="server" DataValueField="IDA" DataTextField="STAFF_NAME" AutoPostBack="true" Width="100%"></asp:DropDownList>
                    </div>
                    <div class="col-lg-1"></div>
                </div>
            </div>
