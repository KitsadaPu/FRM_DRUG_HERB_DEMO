            ...
            <div class="row" runat="server" id="P12" visible="false">
                ...
                <div class="row" runat="server">
                    ...
                    <div class="col-lg-6">
                        ...
                        <telerik:RadComboBox ID="DD_ML_ID" runat="server" Filter="Contains" Width="100%" AutoPostBack="true"></telerik:RadComboBox>
                    </div>
                    <div class="col-lg-1"></div>
                </div>
                <div class="row" runat="server">
                ...
                <div class="row" runat="server">
                    ...
                    <div class="col-lg-6">
                        <asp:DropDownList ID="DDL_DISCOUNT" runat="server" DataValueField="DISCOUNT_ID" DataTextField="DISCOUNT" AutoPostBack="true" Width="100%"></asp:DropDownList>
                    </div>
                    <div class="col-lg-1"></div>
                </div>
                <div class="row" runat="server">
