...
Public Class POPUP_LCN_EDIT_CONFIRM_DETAIL
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Else
            ...
            RCVNO = bao.GEN_RCVNO_NO(con_year(Date.Now.Year()), pvncd, dao.fields.LCN_PROCESS_ID, _IDA)
            ...
            Dim RCVNO_FULL As String = "HB" & " " & pvncd & "-" & dao.fields.LCN_PROCESS_ID & "-" & DATE_YEAR & "-" & RCVNO_HERB_NEW
