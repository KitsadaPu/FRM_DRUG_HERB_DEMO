    ...
    <div>
        ...
        <div class="row">
          ...
          <div class="row">
            <div class="col-lg-1"></div>
            <div class="col-lg-2">
                <asp:Label ID="Label9" runat="server" Text="เลขรับหนังสือกองผลิตภัณฑ์สมุนไพร" Font-Size="Medium"></asp:Label>
            </div>
            <div class="col-lg-2">
                <asp:TextBox ID="txt_rcvno_herb" runat="server" Width="100%" ></asp:TextBox>
                <asp:Label ID="lbl_rcvno_herb" runat="server" Text="*กรุณากรอกข้อมูล เลขรับ"  ForeColor="Red" Font-Size="Small" Visible="false"></asp:Label>
            </div>
            <div class="col-lg-1"></div>
        </div>
    </div>
