<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_PRODUCK_HERB.Master" CodeBehind="FRM_TABEAN_HERB_TEMPOLARY.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_TABEAN_HERB_TEMPOLARY" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-lg-12" style="text-align: center;">
             <h3><asp:Label ID="HEAD_TEXT" runat="server" Text="การขออนุญาตแก้ไขเปลี่ยนแปลงใบสำคัญการขึ้นทะเบียนผลิตภัณฑ์สมุนไพร"></asp:Label></h3>
        </div>
    </div>
