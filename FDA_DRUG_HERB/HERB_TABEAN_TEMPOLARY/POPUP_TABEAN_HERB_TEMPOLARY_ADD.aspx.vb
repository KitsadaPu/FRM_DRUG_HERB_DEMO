    ...
    Protected Sub btn_save_Click(sender As Object, e As EventArgs) Handles btn_save.Click
        If txt_name_request.Text Is Nothing Or txt_name_request.Text = "" _
            ...
            Or txt_email.Text Is Nothing Or txt_email.Text = "" _
             Or txt_phone.Text Is Nothing Or txt_phone.Text = "" _
             Or txt_rcvno_herb.Text Is Nothing Or txt_rcvno_herb.Text = "" Then
            ...
            End If
            If txt_rcvno_herb.Text Is Nothing Or txt_rcvno_herb.Text = "" Then
                lbl_rcvno_herb.Visible = True
            Else
                lbl_rcvno_herb.Visible = False
            End If
        ...
        Else
            ...
            If dao.fields.IDA <> 0 Then
                ...
                End Try
                dao.fields.CERTIFICATE_RCVNO = txt_rcvno_herb.Text
                ...
                If DD_PRICE_REQUEST.SelectedValue = 14 Then
