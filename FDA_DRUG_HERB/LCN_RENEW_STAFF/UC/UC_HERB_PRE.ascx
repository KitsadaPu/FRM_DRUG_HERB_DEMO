    ...
    <form name="form" method="post" align="center;">
        ...
        <div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6" >
                    <asp:TextBox ID="lbl_lcn_name" runat="server"  Width="100%"></asp:TextBox>
            ...
            <div class="row">
                ...
                <div class="col-lg-1" style="; text-align: center">
                    <asp:TextBox ID="lbl_lcn_ages" runat="server"  Width="100%"></asp:TextBox>
                ...
                <div class="col-lg-2" style="; text-align: center">
                    <asp:TextBox ID="lbl_lcn_nation" runat="server" ></asp:TextBox>
            ...
            <div class="row">
                ...
                <div class="col-lg-5
                                        "
                    >
                    <asp:TextBox ID="lbl_lcn_iden" runat="server"  Width="100%"></asp:TextBox>
            ...
            <div class="row">
                ...
                <div class="col-lg-2" >
                    <asp:TextBox ID="lbl_lcn_addr" runat="server" ></asp:TextBox>
                ...
                <div class="col-lg-2" >
                    <asp:TextBox ID="lbl_lcn_floor" runat="server" ></asp:TextBox>
            ...
            <div class="row">
                ...
                <div class="col-lg-2" >
                    <asp:TextBox ID="lbl_lcn_room" runat="server" ></asp:TextBox>
                ...
                <div class="col-lg-2" >
                    <asp:TextBox ID="lbl_lcn_building" runat="server" ></asp:TextBox>
            ...
            <div class="row">
                ...
                <div class="col-lg-2" >
                    <asp:TextBox ID="lbl_lcn_mu" runat="server" ></asp:TextBox>
                ...
                <div class="col-lg-2" >
                    <asp:TextBox ID="lbl_lcn_soi" runat="server" ></asp:TextBox>
            ...
            <div class="row">
                ...
                <div class="col-lg-6" >
                    <asp:TextBox ID="lbl_lcn_road" runat="server"  Width="100%"></asp:TextBox>
            ...
            <div class="row">
                ...
                <div class="col-lg-2" >
                    <asp:TextBox ID="lbl_lcn_tambol" runat="server" ></asp:TextBox>
                ...
                <div class="col-lg-2" >
                    <asp:TextBox ID="lbl_lcn_amphor" runat="server" ></asp:TextBox>
            ...
            <div class="row">
                ...
                <div class="col-lg-2" >
                    <asp:TextBox ID="lbl_lcn_changwat" runat="server" ></asp:TextBox>
                ...
                <div class="col-lg-2" >
                    <asp:TextBox ID="lbl_lcn_zipcode" runat="server" ></asp:TextBox>
            ...
            <div class="row">
                ...
                <div class="col-lg-2" >
                    <asp:TextBox ID="lbl_lcn_fax" runat="server" ></asp:TextBox>
                ...
                <div class="col-lg-2" >
                    <asp:TextBox ID="lbl_lcn_tel" runat="server" ></asp:TextBox>
           ...
           <div>
               <div class="row">
                   ...
                   <div class="col-lg-2" >
                       ...
                       <asp:TextBox ID="lbl_lct_thanameplace" runat="server" ></asp:TextBox>
                   </div>
                   <div class="col-lg-6"></div>
               ...
               <div class="row">
                   ...
                   <div class="col-lg-2" >
                       <asp:TextBox ID="lbl_lct_HOUSENO" runat="server" ></asp:TextBox>
               ...
               <div class="row">
                   ...
                   <div class="col-lg-2">หมู่บ้าน/อาคาร :</div>
                   <div class="col-lg-2" >
                       <asp:TextBox ID="lbl_lct_thabuilding" runat="server"  Width="100%"></asp:TextBox>
                       <%-- <asp:Label ID="lbl_lct_thabuilding" runat="server" Text=""></asp:Label>--%>
                   </div>
                   <div class="col-lg-2" style="text-align: center">ชั้น :</div>
                   <div class="col-lg-2" >
                       <asp:TextBox ID="lbl_lct_floor" runat="server"  Width="100%"></asp:TextBox>
               ...
               <div class="row">
                   ...
                   <div class="col-lg-2">หมู่ที่ :</div>
                   <div class="col-lg-2" >
                       <asp:TextBox ID="lbl_lct_thamu" runat="server" ></asp:TextBox>
                   </div>
                   <div class="col-lg-2" style="text-align: center">ตรอก/ซอย :</div>
                   <div class="col-lg-2" >
                       <asp:TextBox ID="lbl_lct_thasoi" runat="server" ></asp:TextBox>
                       <%-- <asp:Label ID="lbl_lct_thasoi" runat="server" Text=""></asp:Label>--%>
                   </div>
                   <div class="col-lg-1"></div>
               </div>
               <div class="row">
                   ...
                   <div class="col-lg-2">&nbsp;ถนน :</div>
                   <div class="col-lg-2" >
                       <asp:TextBox ID="lbl_lct_tharoad" runat="server" ></asp:TextBox>
               ...
               <div class="row">
                   ...
                   <div class="col-lg-2">ตำบล/แขวง :</div>
                   <div class="col-lg-2" >
                       <asp:TextBox ID="lbl_lct_thathmblnm" runat="server" ></asp:TextBox>
                       <%-- <asp:Label ID="lbl_lct_thathmblnm" runat="server" Text=""></asp:Label>--%>
                   </div>
                   <div class="col-lg-2" style="text-align: center">&nbsp;อำเภอ/เขต :</div>
                   <div class="col-lg-2" >
                       <asp:TextBox ID="lbl_lct_thaamphrnm" runat="server" ></asp:TextBox>
               ...
               <div class="row">
                   ...
                   <div class="col-lg-2">จังหวัด :</div>
                   <div class="col-lg-2" >
                       <asp:TextBox ID="lbl_lct_thachngwtnm" runat="server" ></asp:TextBox>
                   </div>
                   <div class="col-lg-2" style="text-align: center">รหัสไปรษณีย์ :</div>
                   <div class="col-lg-2" >
                       <asp:TextBox ID="lbl_lct_zipcode" runat="server" ></asp:TextBox>
               ...
               <div class="row">
                   ...
                   <div class="col-lg-2">E-mail :</div>
                   <div class="col-lg-2" >
                       <asp:TextBox ID="Label59" runat="server" ></asp:TextBox>
                   </div>
               </div>
           </div>
    </form>
