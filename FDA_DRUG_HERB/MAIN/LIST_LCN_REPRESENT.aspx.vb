...
Public Class LIST_LCN_REPRESENT
    ...
    Protected Sub rgns_NeedDataSource(sender As Object, e As GridNeedDataSourceEventArgs) Handles rgns.NeedDataSource
        ...
        dt = bao.SP_LIST_LCN_REPRESENT(_IDA)
    ...
    Protected Sub rgns_ItemCommand(sender As Object, e As GridCommandEventArgs) Handles rgns.ItemCommand
        If TypeOf e.Item Is GridDataItem Then
            ...
            Dim id_dalcn As String = item("ID_DALCN").Text
            ...
            If e.CommandName = "sele" Then
                ...
                System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups2('" & "POPUP_CONFIRM_LCN_REPRESENT.aspx?&ID=" & id & "&ID_DALCN=" & id_dalcn & "');", True)
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups2('" & "POPUP_LCN_REPRESENT.aspx?IDA=" & _IDA & "&ID_LCN=" & _id_lcn & "&identify=" & _iden & "&lct_ida=" & _lct_ida & "');", True)
