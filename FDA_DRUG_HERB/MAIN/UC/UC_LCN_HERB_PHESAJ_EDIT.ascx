<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UC_LCN_HERB_PHESAJ_EDIT.ascx.vb" Inherits="FDA_DRUG_HERB.UC_LCN_HERB_PHESAJ_EDIT" %>
...
<%--    <div class="row">
    ...
    <div class="row">
        <div class="col-lg-1"></div>
        <div class="col-lg-3">
            <asp:Button ID="btn_save_phr" runat="server" Text="เพิ่มผู้มีหน้าที่ปฎิบัติการ" />
