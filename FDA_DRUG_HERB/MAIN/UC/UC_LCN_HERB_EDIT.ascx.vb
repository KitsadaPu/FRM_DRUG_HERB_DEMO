...
Public Class UC_LCN_HERB_EDIT
    ...
    Sub set_ddl_place()
        ...
        dao.GetDataby_IDA(ida_fk_dalcn_fix)
        Try
        ...
        If ddl_placename.SelectedValue <> "" Or cb_location.Checked Then
            ...
            Try
                ...
                If ddl_placename.Items.Count > 0 Then
                    Dim dao_DALCN_DETAIL_LOCATION_KEEP As New DAO_DRUG.TB_DALCN_DETAIL_LOCATION_KEEP_FIX
                    Dim dao_LOCATION_ADDRESS_2 As New DAO_DRUG.TB_DALCN_LOCATION_ADDRESS
                    dao_DALCN_DETAIL_LOCATION_KEEP.GetDataby_BY_FK(ida_fk_dalcn_fix)
                    ...
                    End Try
                    Try
                        dao_DALCN_DETAIL_LOCATION_KEEP.fields.FK_IDA = ida_fk_dalcn_fix
                    Catch ex As Exception
                    ...
                    dao_DALCN_DETAIL_LOCATION_KEEP.fields.ID_DALCN = Request.QueryString("ida")
                    dao_DALCN_DETAIL_LOCATION_KEEP.fields.ACTIVE = 1
                    dao_DALCN_DETAIL_LOCATION_KEEP.insert()


                    RadGrid2.Rebind()
                    Response.Write("<script type='text/javascript'>window.parent.alert('เพิ่มข้อมูลสถานเรียบร้อยแล้ว');</script> ")

                    'KEEP_LOCATION_LOGS_EDIT(Request.QueryString("ida"), "เพิ่มข้อมูลสถานที่ " & " " & dao_DALCN_DETAIL_LOCATION_KEEP.fields.LOCATION_ADDRESS_thaaddr & " " & dao_DALCN_DETAIL_LOCATION_KEEP.fields.LOCATION_ADDRESS_thathmblnm & " " & dao_DALCN_DETAIL_LOCATION_KEEP.fields.LOCATION_ADDRESS_thaamphrnm & " " & dao_DALCN_DETAIL_LOCATION_KEEP.fields.LOCATION_ADDRESS_thachngwtnm & " " & dao_DALCN_DETAIL_LOCATION_KEEP.fields.LOCATION_ADDRESS_zipcode, _CLS.CITIZEN_ID)
                End If
            Catch ex As Exception
    ...
    Private Sub RadGrid2_ItemCommand(sender As Object, e As Telerik.Web.UI.GridCommandEventArgs) Handles RadGrid2.ItemCommand
        If TypeOf e.Item Is GridDataItem Then
            ...
            If e.CommandName = "_del" Then
                ...
                dao_DALCN_DETAIL_LOCATION_KEEP.GetDataby_id(_ida)
                name_del = dao_DALCN_DETAIL_LOCATION_KEEP.fields.LOCATION_ADDRESS_thaamphrnm
                dao_DALCN_DETAIL_LOCATION_KEEP.fields.ACTIVE = 0
                dao_DALCN_DETAIL_LOCATION_KEEP.update()
                RadGrid2.Rebind()

                'KEEP_LOCATION_LOGS_EDIT(Request.QueryString("ida"), "ลบข้อมูลสถานที่ " & " " & dao_DALCN_DETAIL_LOCATION_KEEP.fields.LOCATION_ADDRESS_thaaddr & " " & dao_DALCN_DETAIL_LOCATION_KEEP.fields.LOCATION_ADDRESS_thathmblnm & " " & dao_DALCN_DETAIL_LOCATION_KEEP.fields.LOCATION_ADDRESS_thaamphrnm & " " & dao_DALCN_DETAIL_LOCATION_KEEP.fields.LOCATION_ADDRESS_thachngwtnm & " " & dao_DALCN_DETAIL_LOCATION_KEEP.fields.LOCATION_ADDRESS_zipcode, _CLS.CITIZEN_ID)
            End If
        End If
    End Sub
