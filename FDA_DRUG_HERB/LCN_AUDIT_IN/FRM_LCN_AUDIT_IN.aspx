<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN.Master" CodeBehind="FRM_LCN_AUDIT_IN.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_LCN_AUDIT_IN" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-lg-12" style="text-align: center;">
             <h3><asp:Label ID="HEAD_TEXT" runat="server" Text="คำขอให้ตรวจประเมินสถานที่ผลิตผลิตภัณฑ์สมุนไพร"></asp:Label></h3>
           <%-- <label id="HEAD_TEXT" runat="server" >แบบคำขอตรวจประเมินสถานที่ ผลิต นำเข้า ขาย สำหรับสถานประกอบการในประเทศ</label>--%>
        </div>
    </div>
            ...
            <MasterTableView AutoGenerateColumns="False" DataKeyNames="IDA">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="STATUS_ID" FilterControlAltText="Filter STATUS_ID column"
                     ...
                     <telerik:GridBoundColumn DataField="AUDIT_NAME" FilterControlAltText="Filter AUDIT_NAME column"
                        HeaderText="ผู้รับอนุญาต" ReadOnly="True" SortExpression="AUDIT_NAME" UniqueName="AUDIT_NAME">
                    </telerik:GridBoundColumn>
                  ...
                  <%--  <telerik:GridBoundColumn DataField="STUDY_LEVEL" FilterControlAltText="Filter STUDY_LEVEL column"
                     ...
                     <telerik:GridBoundColumn DataField="Name_Production_site" FilterControlAltText="Filter Name_Production_site column"
                        HeaderText="ชื่อสถานที่ผลิต" ReadOnly="True" SortExpression="Name_Production_site" UniqueName="Name_Production_site" >
                    </telerik:GridBoundColumn>
