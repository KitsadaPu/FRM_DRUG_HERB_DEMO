<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UC_LCN_AUDIT_IN_DETAIL_GROUP_DRUG.ascx.vb" Inherits="FDA_DRUG_HERB.UC_LCN_AUDIT_IN_DETAIL_GROUP_DRUG" %>
