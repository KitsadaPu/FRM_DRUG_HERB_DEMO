...
Public Class FRM_RGT_EDIT_CONFIRM_STAFF
    ...
    Private Sub BindData_PDF()
        ...
        'Dim dao_lcn As New DAO_XML_SEARCH_DRUG_LCN_ESUB.TB_XML_SEARCH_DRUG_LCN_ESUB 'DAO_DRUG.ClsDBdalcn           เก่า
        Dim dao_lcn As New DAO_XML_DRUG_HERB.TB_XML_SEARCH_DRUG_LCN_HERB 'DAO_DRUG.ClsDBdalcn
        Dim dao As New DAO_DRUG.TB_DRRGT_EDIT_REQUEST
        ' Dim dao_drrgt As New DAO_XML_SEARCH_DRUG_LCN_ESUB.TB_XML_SEARCH_PRODUCT_GROUP_ESUB 'DAO_DRUG.ClsDBdrrgt        เก่า
