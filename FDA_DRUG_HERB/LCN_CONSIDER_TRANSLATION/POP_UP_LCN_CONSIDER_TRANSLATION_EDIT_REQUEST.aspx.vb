...
Public Class POP_UP_LCN_CONSIDER_TRANSLATION_EDIT_REQUEST
        ...
        For Each tr As TableRow In tb_upload_file.Rows
            ...
            If f.HasFile Then
                ...
                If exten.ToUpper = "PDF" Then
                    ...
                    dao_f.update()
                    Dim paths As String = System.Configuration.ConfigurationManager.AppSettings("PATH_XML_PDF_LCN_PLAN")
