...
Public Class FRM_LCN_EDIT_STAFF_INTAKE
    ...
    Public Sub bind_pdf_xml_3(ByVal _IDA As Integer, ByVal LCN_IDA As Integer, ByVal _ProcessID As Integer, ByVal _StatusID As Integer, ByVal _YEAR As String, ByVal _tr_id_xml As String)
