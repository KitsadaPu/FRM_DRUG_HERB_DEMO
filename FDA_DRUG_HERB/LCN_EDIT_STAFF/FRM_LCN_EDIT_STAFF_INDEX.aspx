...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  <%--  <link href="../css/css_rg_herb.css" rel="stylesheet" />--%>
    <div class="row" style="text-align: center">
        <h3>รายการข้อมูลยื่นคำขอแก้ไขข้อมูลใบอนุญาติ</h3>
    </div>
    <div class="row">

        <div class="col-lg-12">
            <telerik:RadGrid ID="RadGrid1" runat="server" Skin="Silk" HeaderStyle-Font-Size="Small" PageSize="15" AllowFilteringByColumn="True">
