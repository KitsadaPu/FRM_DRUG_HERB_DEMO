<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN.Master" CodeBehind="FRM_LCN_AUDIT_OUT.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_LCN_AUDIT_OUT" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-lg-12" style="text-align: center;">
            <h3>คำขอให้ตรวจประเมินสถานที่ผลิตผลิตภัณฑ์สมุนไพร (ต่างประเทศ)</h3>
        </div>
    </div>
            ...
            <MasterTableView AutoGenerateColumns="False" DataKeyNames="IDA">
                ...
                <Columns>
                  ...
                  <%--  <telerik:GridBoundColumn DataField="STUDY_LEVEL" FilterControlAltText="Filter STUDY_LEVEL column"
                     ...
                     <telerik:GridBoundColumn DataField="FOREIGN_NAME" FilterControlAltText="Filter FOREIGN_NAME column"
                        HeaderText="ชื่อสถานที่ผลิต" ReadOnly="True" SortExpression="FOREIGN_NAME" UniqueName="FOREIGN_NAME" >
                    </telerik:GridBoundColumn>
