Public Class POP_UP_LCN_AUDIT_OUT_ADD
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        UC_LCN_AUDIT_OUT_DETAIL_GROUP_DRUG.bind_head()
        UC_LCN_AUDIT_OUT_DETAIL_GROUP_DRUG.BindTable()
        If Not IsPostBack Then
            UC_LCN_AUDIT_OUT_DETAIL.get_data(_IDA_LCN)
            UC_LCN_AUDIT_OUT_DETAIL.Search_frgn()
            UC_LCN_AUDIT_OUT_DETAIL_GROUP_DRUG.get_data(_IDA_LCN)
        End If
    End Sub
    ...
    Protected Sub btn_save_Click(sender As Object, e As EventArgs) Handles btn_save.Click
        ...
        UC_LCN_AUDIT_OUT_DETAIL.save_data(dao)
        ...
        dao.insert()
        Try
            UC_LCN_AUDIT_OUT_DETAIL_GROUP_DRUG.save_data(dao.fields.IDA)
            UC_LCN_AUDIT_OUT_DETAIL_GROUP_DRUG.save_data_tb(dao.fields.IDA)
        Catch ex As Exception
    ...
    Sub alert_summit(ByVal text As String, ByVal ida As Integer)
        Dim url As String = ""
        url = "POP_UP_LCN_AUDIT_OUT_UPLOAD.aspx?IDA=" & ida & "&PROCESS_ID=" & _ProcessID
