Public Class UC_LCN_AUDIT_OUT_DETAIL_GROUP_DRUG
    ...
    Public Sub BindTable()
        ...
        Dim dao_f As New DAO_LCN.TB_MAS_LCN_AUDIT_DETAIL_GROUP_DRUG
    ...
    Sub get_data(ByVal IDA_LCN As Integer)
        ...
        With dao.fields
            txt_Name_Production_site.Text = .thanameplace
        End With
    ...
    Sub save_data(ByVal IDA As Integer)
        ...
        dao.fields.Name_Contact_More = txt_name_more.Text
        dao.fields.Tel_More = txt_tel_more.Text
        dao.fields.Mobile_More = txt_mobile_more.Text
        dao.fields.Email_More = txt_email_more.Text
        dao.update()
    End Sub
