...
Public Class FRM_HERB_TABEAN_RENEW_MAIN
    ...
    Private Sub RadGrid1_ItemDataBound(sender As Object, e As GridItemEventArgs) Handles RadGrid1.ItemDataBound
        If e.Item.ItemType = GridItemType.AlternatingItem Or e.Item.ItemType = GridItemType.Item Then
            ...
            H.NavigateUrl = "FRM_HERB_TABEAN_RENEW.aspx?IDA_LCN=" & _IDA_LCN & "&IDA_DR=" & IDA_DR & "&MENU_GROUP=" & _MENU_GROUP & "&PROCESS_DR=" & PROCESS_ID & "&TR_ID_DR=" & TR_ID_DR & "&PROCESS_ID=" & DD_DRRGT_PROCESS_ID.SelectedValue 'URL หน้า ยืนยัน
