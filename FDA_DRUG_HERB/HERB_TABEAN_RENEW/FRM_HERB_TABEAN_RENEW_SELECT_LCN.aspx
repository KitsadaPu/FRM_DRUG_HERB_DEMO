<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Main_PPK.Master" CodeBehind="FRM_HERB_TABEAN_RENEW_SELECT_LCN.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_HERB_TABEAN_RENEW_SELECT_LCN" %>
    ...
    <div class="row" id="T1" runat="server" visible="false">
        <div class="panel panel-body" style="width: 100%;height:780px; padding-left: 1em">
            <div class="panel-heading panel-title" style="height: 70px">
                <p class="h3" style="text-align: left; border-bottom: 3px solid gray;">คำขอต่ออายุทะเบียนผลิตภัณฑ์สมุนไพร</p>
            </div>
