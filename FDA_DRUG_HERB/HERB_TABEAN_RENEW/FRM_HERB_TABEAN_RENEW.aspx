<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Main_Product.Master" CodeBehind="FRM_HERB_TABEAN_RENEW.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_HERB_TABEAN_RENEW" %>
    ...
    <div class="panel" style="text-align: left; width: 100%">
        <div class="panel-heading panel-title" style="height: 70px">
            ...
            <div class="col-lg-3 col-md-3">
                <h4>คำขอต่ออายุ<asp:Label ID="lbl_name_2" runat="server" Text=""></asp:Label><asp:Label ID="lbl_name" runat="server" Text="">
                </asp:Label>
                </h4>
            </div>
            ...
            <div class="col-lg-3 col-md-3">
                <asp:Button ID="btn_add" runat="server" Text="เพิ่มคำขอต่ออายุ" CssClass="auto-style1" Height="45px" Width="200px" />
