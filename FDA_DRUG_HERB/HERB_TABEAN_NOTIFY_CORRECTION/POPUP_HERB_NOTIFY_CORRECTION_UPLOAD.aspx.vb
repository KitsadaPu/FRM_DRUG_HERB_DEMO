Public Class POPUP_HERB_NOTIFY_CORRECTION_UPLOAD
    ...
    Sub alert_normal(ByVal text As String)
        Dim url As String = ""
        url = "FRM_HERB_NOTIFY_CORRECTION.aspx?PROCESS_ID=" & _PROCESS_ID & "&IDA=" & _IDA
    ...
    Sub alert_file_error(ByVal text As String)
        Dim url As String = ""
        url = "POPUP_HERB_NOTIFY_CORRECTION_UPLOAD.aspx?PROCESS_ID=" & _PROCESS_ID & "&IDA=" & _IDA
