        ...
        If TypeOf e.Item Is GridDataItem Then
            ...
            If e.CommandName = "HL_SELECT" Then
                If STATUS_ID = 11 Then
                    ...
                    System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups2('" & " POPUP_TABEAN_HERB_ANALYZE_EDIT_REQUEST.aspx?IDA_DR=" & _IDA_DR & "&PROCESS_ID=" & _PROCESS_ID & "&IDA=" & IDA & "&IDA_LCN=" & _IDA_LCN & "');", True)
                Else
