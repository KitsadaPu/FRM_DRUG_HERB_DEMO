...
Public Class POPUP_PHR_HERB_EDIT
    ...
    Sub RunSession()
        ...
        _IDA = Request.QueryString("PHR_IDA")
        ...
        If dao.fields.Check_Edit_FileUpload_ID = True Then
            ...
            Else
                If dao.fields.Check_Edit_ID = False Then
                    dao.fields.phr_status = 5
                    dao.update()
                    AddLogStatus(dao.fields.phr_status, _ProcessID, _CLS.CITIZEN_ID, Request.QueryString("PHR_IDA"))
    ...
    Private Function check_file()
        ...
        Dim dao As New DAO_DRUG.ClsDBDALCN_PHR
        dao.GetDataby_IDA(_IDA)
        Dim TR_ID As Integer = dao.fields.TRANSECTION_ID_UPLOAD
