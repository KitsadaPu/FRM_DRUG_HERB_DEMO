Public Class UC_ATTACH
    ...
    Public Function insert_JJ_EDIT(ByVal TR_ID As Integer, ByVal PROCESS_ID As Integer, ByVal IDA_DR As Integer, ByVal TYPE_ID As Integer) As Boolean
        ...
        Return result
    End Function
    Public Function insert_TBN_SUB(ByVal TR_ID As Integer, ByVal PROCESS_ID As Integer, ByVal IDA_DR As Integer, ByVal TYPE_ID As Integer) As Boolean
        Dim result As Boolean = True
        If HiddenField1.Value = 0 Then ' ไม่จำเป็นต้องมี
            If FileUpload1.HasFile Then

                insert_file_TBN_SUB(TR_ID, PROCESS_ID, IDA_DR, TYPE_ID)
            End If
        Else 'จำเป็นต้องแนบ
            If FileUpload1.HasFile Then
                insert_file_TBN_SUB(TR_ID, PROCESS_ID, IDA_DR, TYPE_ID)
    ...
    Public Function insert_TBNTEMPO(ByVal TR_ID As Integer, ByVal PROCESS_ID As Integer, ByVal IDA_DR As Integer, ByVal TYPE_ID As Integer) As Boolean
        ...
        Return result
    End Function
    Public Function insert_EX(ByVal TR_ID As Integer, ByVal PROCESS_ID As Integer, ByVal IDA_DR As Integer, ByVal TYPE_ID As Integer) As Boolean
        Dim result As Boolean = True
        If HiddenField1.Value = 0 Then ' ไม่จำเป็นต้องมี
            If FileUpload1.HasFile Then

                insert_file_EX(TR_ID, PROCESS_ID, IDA_DR, TYPE_ID)
            End If
        Else 'จำเป็นต้องแนบ
            If FileUpload1.HasFile Then
                insert_file_EX(TR_ID, PROCESS_ID, IDA_DR, TYPE_ID)
        ...
        Return result
    End Function
    Public Function insert_AD(ByVal TR_ID As Integer, ByVal PROCESS_ID As Integer, ByVal IDA_DR As Integer, ByVal TYPE_ID As Integer) As Boolean
        Dim result As Boolean = True
        If HiddenField1.Value = 0 Then ' ไม่จำเป็นต้องมี
            If FileUpload1.HasFile Then
    ...
    Public Function insert_lcn(ByVal TR_ID As Integer, ByVal PROCESS_ID As Integer, ByVal IDA_DR As Integer, ByVal TYPE_ID As Integer) As Boolean
        ...
        Return result
    End Function
    Private Sub insert_file_lcn(ByVal TR_ID As Integer, ByVal PROCESS_ID As Integer, ByVal IDA_DR As Integer, ByVal TYPE_ID As Integer)
    ...
    Private Sub insert_file_TBN(ByVal TR_ID As Integer, ByVal PROCESS_ID As Integer, ByVal IDA_DR As Integer, ByVal TYPE_ID As Integer)
        ...
        'FileUpload1.SaveAs(_PATH_FILE & "/UPLOAD_FILE_JJ/" & TR_ID & "_" & H_TYPE.Value & "." & extensionname)
        FileUpload1.SaveAs(_PATH_FILE & "/UPLOAD_PDF_TABEAN_TBN/" & "HB_PDF-" & PROCESS_ID & "_" & con_year(Date.Now.Year) & "_" & TR_ID & "_" & TYPE_ID & "_" & "." & extensionname)
        Dim dao_file As New DAO_TABEAN_HERB.TB_TABEAN_HERB_UPLOAD_FILE_JJ
    ...
    Private Sub insert_file_JJ_EDIT(ByVal TR_ID As Integer, ByVal PROCESS_ID As Integer, ByVal IDA_DR As Integer, ByVal TYPE_ID As Integer)
        ...
        dao_file.insert()
    End Sub
    Private Sub insert_file_TBN_SUB(ByVal TR_ID As Integer, ByVal PROCESS_ID As Integer, ByVal IDA_DR As Integer, ByVal TYPE_ID As Integer)
        Dim extensionname As String = GetExtension(FileUpload1.FileName)
        Dim _PATH_FILE As String = System.Configuration.ConfigurationManager.AppSettings("PATH_XML_PDF_TABEAN_SUB")
        'FileUpload1.SaveAs(_PATH_FILE & "/UPLOAD_FILE_JJ/" & TR_ID & "_" & H_TYPE.Value & "." & extensionname)
        FileUpload1.SaveAs(_PATH_FILE & "/FILE_UPLOAD/" & "HB_PDF-" & PROCESS_ID & "_" & con_year(Date.Now.Year) & "_" & TR_ID & "_" & TYPE_ID & "_" & H_TYPE.Value & "." & extensionname)
        Dim dao_file As New DAO_TABEAN_HERB.TB_TABEAN_HERB_UPLOAD_FILE_JJ
    ...
    Private Sub insert_file_TBN_NEW(ByVal TR_ID As Integer, ByVal PROCESS_ID As Integer, ByVal IDA_DR As Integer, ByVal TYPE_ID As Integer)
        ...
        dao_file.insert()
    End Sub
    Public Sub insert_file_EX(ByVal TR_ID As Integer, ByVal PROCESS_ID As Integer, ByVal IDA_DR As Integer, ByVal TYPE_ID As Integer)
        Dim extensionname As String = GetExtension(FileUpload1.FileName)
        Dim _PATH_FILE As String = System.Configuration.ConfigurationManager.AppSettings("PATH_XML_PDF_TABEAN_EX")
        'FileUpload1.SaveAs(_PATH_FILE & "/UPLOAD_FILE_JJ/" & TR_ID & "_" & H_TYPE.Value & "." & extensionname)
        FileUpload1.SaveAs(_PATH_FILE & "/UPLOAD_PDF_TABEAN_EX/" & "HB_PDF-" & PROCESS_ID & "_" & con_year(Date.Now.Year) & "_" & TR_ID & "_" & TYPE_ID & "_" & H_TYPE.Value & "." & extensionname)
        Dim dao_file As New DAO_TABEAN_HERB.TB_TABEAN_HERB_UPLOAD_FILE_JJ
    ...
    Public Sub insert_file_AD(ByVal TR_ID As Integer, ByVal PROCESS_ID As String, ByVal IDA_DR As Integer, ByVal TYPE_ID As Integer)
        Dim extensionname As String = GetExtension(FileUpload1.FileName)
        Dim _PATH_FILE As String = System.Configuration.ConfigurationManager.AppSettings("PATH_XML_PDF_AUDIT")
        If PROCESS_ID = 10901 Then
            FileUpload1.SaveAs(_PATH_FILE & "/FILE_UPLOAD/" & "ADI-" & PROCESS_ID & "_" & con_year(Date.Now.Year) & "_" & TR_ID & "_" & TYPE_ID & "_" & H_TYPE.Value & "." & extensionname)
        Else
            FileUpload1.SaveAs(_PATH_FILE & "/FILE_UPLOAD/" & "ADO-" & PROCESS_ID & "_" & con_year(Date.Now.Year) & "_" & TR_ID & "_" & TYPE_ID & "_" & H_TYPE.Value & "." & extensionname)
        End If


        Dim dao_file As New DAO_DRUG.TB_DALCN_UPLOAD_FILE
        If PROCESS_ID = 10901 Then
            dao_file.fields.NAME_FAKE = "ADI-" & PROCESS_ID & "_" & con_year(Date.Now.Year) & "_" & TR_ID & "_" & TYPE_ID & "_" & H_TYPE.Value & "." & extensionname
        Else
            dao_file.fields.NAME_FAKE = "ADO-" & PROCESS_ID & "_" & con_year(Date.Now.Year) & "_" & TR_ID & "_" & TYPE_ID & "_" & H_TYPE.Value & "." & extensionname
        End If
        'dao_file.fields.NAME_FAKE = "HB_PDF" & TR_ID & "_" & H_TYPE.Value & "." & extensionname
    ...
    Private Sub insert_file_renew(ByVal TR_ID As Integer, ByVal PROCESS_ID As Integer, ByVal IDA_DR As Integer, ByVal TYPE_ID As Integer)
        Dim extensionname As String = GetExtension(FileUpload1.FileName)
        Dim _PATH_FILE As String = System.Configuration.ConfigurationManager.AppSettings("PATH_XML_PDF_LCN_RENREW")
        FileUpload1.SaveAs(_PATH_FILE & "/FILE_UPLOAD/" & "HB-" & PROCESS_ID & "-" & Date.Now.Year & "-" & TR_ID & "-" & TYPE_ID & "_" & H_TYPE.Value & "." & extensionname)

        Dim dao_file As New DAO_DRUG.TB_DALCN_UPLOAD_FILE

        'dao_file.fields.NAME_FAKE = "HB_PDF" & TR_ID & "_" & H_TYPE.Value & "." & extensionname
        dao_file.fields.NAME_FAKE = "HB-" & PROCESS_ID & "_" & con_year(Date.Now.Year) & "_" & TR_ID & "_" & TYPE_ID & "_" & H_TYPE.Value & "." & extensionname
        dao_file.fields.NAME_REAL = FileUpload1.FileName
        dao_file.fields.DOCUMENT_NAME = Label1.Text
        dao_file.fields.TYPE = H_TYPE.Value
        dao_file.fields.TR_ID = TR_ID
        ...
        dao_file.fields.PROCESS_ID = PROCESS_ID
        dao_file.fields.ACTIVE = 1
        dao_file.fields.FilePath = _PATH_FILE & "/FILE_UPLOAD/" & "HB-" & PROCESS_ID & "-" & Date.Now.Year & "-" & TR_ID & "-" & TYPE_ID & "_" & H_TYPE.Value & "." & extensionname
        dao_file.fields.CREATE_DATE = Date.Now
        dao_file.insert()
