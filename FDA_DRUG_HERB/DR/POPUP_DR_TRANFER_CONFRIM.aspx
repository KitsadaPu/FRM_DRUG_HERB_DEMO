<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_DR_TRANFER_CONFRIM.aspx.vb" Inherits="FDA_DRUG_HERB.POPUP_DR_TRANFER_CONFRIM" %>
...
&nbsp;<%--<asp:DropDownList ID="ddl_req_type" runat="server" CssClass="btn-lg"   Width="80%">
                     ...
                     <tr><td><asp:Button ID="btn_confirm" runat="server" Text="ยันยันการ Tranfer" CssClass="btn-lg"   Width="80%" OnClientClick="confirm('ต้องการยืนยันหรือไม่');" /></td></tr>
