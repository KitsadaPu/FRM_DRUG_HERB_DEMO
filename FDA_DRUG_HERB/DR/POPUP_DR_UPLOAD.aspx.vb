...
Public Class POPUP_DR_UPLOAD
    ...
    Sub insert_tabean2(ByVal FK_IDA As Integer, ByVal fk_transfer As Integer)
        ...
        If newcode <> "" Then
            ...
            Try
                'Dim dao_prop_det As New DAO_XML_SEARCH_DRUG_LCN_ESUB.TB_XML_DRUG_COLOR         เก่า
        ...
        'Dim dao_aniuse_rq As New DAO_XML_SEARCH_DRUG_LCN_ESUB.TB_XML_DRUG_ANIMAL_CONSUME       เก่า
