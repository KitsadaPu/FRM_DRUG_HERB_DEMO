...
Imports System.IO
Public Class POPUP_DR_TRANSFER_DL2
            ...
            ElseIf e.CommandName = "tranfer" Then
                Try
                    If RadioButtonList1.SelectedValue <> "" Then
                        ...
                        System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups3('" & "POPUP_DR_TRANFER_CONFRIM.aspx?IDA=" & IDA & "&TR_ID=" & tr_id & "&process=" & dao.fields.PROCESS_ID & "');", True)
                    Else
                        System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "alert('กรุณาเลือกประเภท');", True)
                    End If
                Catch ex As Exception
