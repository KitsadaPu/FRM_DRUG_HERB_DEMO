...
Public Class FRM_LCN_SEACH_SUBTITUTE
    ...
    Protected Sub btn_search_Click(sender As Object, e As EventArgs) Handles btn_search.Click
        ...
        If Request.QueryString("lcn_ida") = "" Then
            ...
            Else
                Response.Redirect("FRM_LCN_SUBSTITUTE_MAIN.aspx?process=" & _process & "&lct_ida=" & _lct_ida & "&identify=" & _iden & "&lcn_ida=" & dao_lcn.fields.IDA & "&LCN_DISPLAY=" & rcb_search.SelectedItem.Text)
