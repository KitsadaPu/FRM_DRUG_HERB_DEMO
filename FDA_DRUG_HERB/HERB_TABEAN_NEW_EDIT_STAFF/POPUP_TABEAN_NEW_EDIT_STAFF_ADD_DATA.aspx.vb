...
Public Class POPUP_TABEAN_NEW_EDIT_STAFF_ADD_DATA
    ...
    Sub Get_data()
        ...
        With dao_c.fields
            ...
            If .SIZE_USE_ID = True Then
                CB_SIZE_USE_ID.Checked = True
                txt_Size_Use_New.Text = dao_d.fields.SIZE_USE
        ...
        NOTE_EDIT.Text = dao.fields.REMARK
    ...
    Protected Sub BTN_SEARCH_LCN_Click(sender As Object, e As EventArgs) Handles BTN_SEARCH_LCN.Click
        If txt_lcnno.Text IsNot "" Then
            ...
            'Dim dao_licen As New DAO_DRUG_ESUB.TB_XML_SEARCH_DRUG_LCN_LICEN_ESUB
            'Dim dao_licen As New DAO_DRUG_HERB.TB_XML_SEARCH_DRUG_LCN_HERB
    ...
    Sub insert_iowa_tabean_edit()
        ...
        dao_eq168.GetDataby_IDA(NEWCODE)
        Dim dao_eq168_OLD As New DAO_TABEAN_HERB.TB_TABEAN_EDIT_REQUEST_EQTO_OLD
        dao_eq168_OLD.GetDataby_IDA(NEWCODE)
        If dao_eq124.fields.IDA <> 0 Then
            If dao_eq168.fields.IDA = 0 Then
                For Each dao_eqto.fields In dao_eqto.datas
                    dao_eq168.fields.pvncd = dao_eq124.fields.pvncd
                    dao_eq168.fields.drgtpcd = dao_eq124.fields.drgtpcd
                    dao_eq168.fields.rgttpcd = dao_eq124.fields.rgttpcd
                    dao_eq168.fields.rgtno = dao_eq124.fields.rgtno
                    dao_eq168.fields.register = dao_eq124.fields.register
                    dao_eq168.fields.CITIZEN_AUTHORIZE = dao_eq124.fields.CITIZEN_AUTHORIZE
                    dao_eq168.fields.thadrgnm = dao_eq124.fields.thadrgnm
                    dao_eq168.fields.engdrgnm = dao_eq124.fields.engdrgnm
                    dao_eq168.fields.flineno = dao_eq124.fields.flineno
                    dao_eq168.fields.drgqty = dao_eq124.fields.drgqty
                    dao_eq168.fields.drgperunit = dao_eq124.fields.drgperunit
                    dao_eq168.fields.drgcdt = dao_eq124.fields.drgcdt
                    dao_eq168.fields.drgcdt_condition = dao_eq124.fields.drgcdt_condition
                    dao_eq168.fields.rid = dao_eq124.fields.rid
                    dao_eq168.fields.elineno = dao_eq124.fields.elineno
                    dao_eq168.fields.iowacd = dao_eq124.fields.iowacd
                    dao_eq168.fields.iowanm = dao_eq124.fields.iowanm
                    dao_eq168.fields.SinggleContent = dao_eq124.fields.SinggleContent
                    dao_eq168.fields.UnitForSinggleContent = dao_eq124.fields.UnitForSinggleContent
                    dao_eq168.fields.qty = dao_eq124.fields.qty
                    dao_eq168.fields.ConditionContent = dao_eq124.fields.ConditionContent
                    dao_eq168.fields.MultiplyNumberStart = dao_eq124.fields.MultiplyNumberStart
                    dao_eq168.fields.BaseNumberStart = dao_eq124.fields.BaseNumberStart
                    dao_eq168.fields.PowerNumberStart = dao_eq124.fields.PowerNumberStart
                    dao_eq168.fields.MultiplyNumberEND = dao_eq124.fields.MultiplyNumberEND
                    dao_eq168.fields.BaseNumberEND = dao_eq124.fields.BaseNumberEND
                    dao_eq168.fields.PowerNumberEND = dao_eq124.fields.PowerNumberEND
                    dao_eq168.fields.UnitForRangeContent = dao_eq124.fields.UnitForRangeContent
                    dao_eq168.fields.aori = dao_eq124.fields.aori
                    dao_eq168.fields.Newcode = dao_eq124.fields.Newcode
                    dao_eq168.fields.Newcode_rid = dao_eq124.fields.Newcode_rid
                    dao_eq168.fields.Newcode_R = dao_eq124.fields.Newcode_R
                    dao_eq168.fields.licen_loca = dao_eq124.fields.licen_loca
                    dao_eq168.fields.thaclassnm = dao_eq124.fields.thaclassnm
                    dao_eq168.fields.cncnm = dao_eq124.fields.cncnm
                    dao_eq168.fields.Newcode_rid_eq = dao_eq124.fields.Newcode_rid_eq
                    dao_eq168.fields.lcnno = dao_eq124.fields.lcnno
                    dao_eq168.fields.remark = dao_eq124.fields.remark
                    dao_eq168.fields.DATE_EDIT = Date.Now
                    dao_eq168.fields.IDEN_EDIT = _CLS.CITIZEN_ID
                    dao_eq168.fields.NAME_EDIT = _CLS.THANM
                    dao_eq168.insert()
                Next
            End If
            ...
            If dao_eq168_OLD.fields.IDA = 0 Then
                For Each dao_eqto.fields In dao_eqto.datas
                    dao_eq168_OLD.fields.pvncd = dao_eq124.fields.pvncd
                    dao_eq168_OLD.fields.drgtpcd = dao_eq124.fields.drgtpcd
                    dao_eq168_OLD.fields.rgttpcd = dao_eq124.fields.rgttpcd
                    dao_eq168_OLD.fields.rgtno = dao_eq124.fields.rgtno
                    dao_eq168_OLD.fields.register = dao_eq124.fields.register
                    dao_eq168_OLD.fields.CITIZEN_AUTHORIZE = dao_eq124.fields.CITIZEN_AUTHORIZE
                    dao_eq168_OLD.fields.thadrgnm = dao_eq124.fields.thadrgnm
                    dao_eq168_OLD.fields.engdrgnm = dao_eq124.fields.engdrgnm
                    dao_eq168_OLD.fields.flineno = dao_eq124.fields.flineno
                    dao_eq168_OLD.fields.drgqty = dao_eq124.fields.drgqty
                    dao_eq168_OLD.fields.drgperunit = dao_eq124.fields.drgperunit
                    dao_eq168_OLD.fields.drgcdt = dao_eq124.fields.drgcdt
                    dao_eq168_OLD.fields.drgcdt_condition = dao_eq124.fields.drgcdt_condition
                    dao_eq168_OLD.fields.rid = dao_eq124.fields.rid
                    dao_eq168_OLD.fields.elineno = dao_eq124.fields.elineno
                    dao_eq168_OLD.fields.iowacd = dao_eq124.fields.iowacd
                    dao_eq168_OLD.fields.iowanm = dao_eq124.fields.iowanm
                    dao_eq168_OLD.fields.SinggleContent = dao_eq124.fields.SinggleContent
                    dao_eq168_OLD.fields.UnitForSinggleContent = dao_eq124.fields.UnitForSinggleContent
                    dao_eq168_OLD.fields.qty = dao_eq124.fields.qty
                    dao_eq168_OLD.fields.ConditionContent = dao_eq124.fields.ConditionContent
                    dao_eq168_OLD.fields.MultiplyNumberStart = dao_eq124.fields.MultiplyNumberStart
                    dao_eq168_OLD.fields.BaseNumberStart = dao_eq124.fields.BaseNumberStart
                    dao_eq168_OLD.fields.PowerNumberStart = dao_eq124.fields.PowerNumberStart
                    dao_eq168_OLD.fields.MultiplyNumberEND = dao_eq124.fields.MultiplyNumberEND
                    dao_eq168_OLD.fields.BaseNumberEND = dao_eq124.fields.BaseNumberEND
                    dao_eq168_OLD.fields.PowerNumberEND = dao_eq124.fields.PowerNumberEND
                    dao_eq168_OLD.fields.UnitForRangeContent = dao_eq124.fields.UnitForRangeContent
                    dao_eq168_OLD.fields.aori = dao_eq124.fields.aori
                    dao_eq168_OLD.fields.Newcode = dao_eq124.fields.Newcode
                    dao_eq168_OLD.fields.Newcode_rid = dao_eq124.fields.Newcode_rid
                    dao_eq168_OLD.fields.Newcode_R = dao_eq124.fields.Newcode_R
                    dao_eq168_OLD.fields.licen_loca = dao_eq124.fields.licen_loca
                    dao_eq168_OLD.fields.thaclassnm = dao_eq124.fields.thaclassnm
                    dao_eq168_OLD.fields.cncnm = dao_eq124.fields.cncnm
                    dao_eq168_OLD.fields.Newcode_rid_eq = dao_eq124.fields.Newcode_rid_eq
                    dao_eq168_OLD.fields.lcnno = dao_eq124.fields.lcnno
                    dao_eq168_OLD.fields.remark = dao_eq124.fields.remark
                    dao_eq168_OLD.fields.DATE_EDIT = Date.Now
                    dao_eq168_OLD.fields.IDEN_EDIT = _CLS.CITIZEN_ID
                    dao_eq168_OLD.fields.NAME_EDIT = _CLS.THANM
                    dao_eq168_OLD.insert()
                Next
            End If
        End If
    ...
    Sub bind_datatable_RG_OTHER()
        ...
        RG_OTHER.DataSource = dao_up.datas
        'RG_ETIQUETQ_NEW.Rebind()
        'Return DT
    End Sub

    Private Sub RG_OTHER_NeedDataSource_NEW(sender As Object, e As GridNeedDataSourceEventArgs) Handles RG_OTHER.NeedDataSource
        bind_datatable_RG_OTHER()
    End Sub
    Private Sub RG_OTHER_ItemDataBound(sender As Object, e As GridItemEventArgs) Handles RG_OTHER.ItemDataBound
