        ...
        If TypeOf e.Item Is GridDataItem Then
            ...
            If e.CommandName = "sel" Then
                ...
                ElseIf STATUS_ID = 8 Then
                    System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups2('" & "POPUP_TABEAN_NEW_EDIT_STAFF_APPROVE.aspx?IDA=" & IDA & "&process_id=" & PROCESS_ID & "&TR_ID=" & TR_ID & "&IDA_LCN=" & IDA_LCN & "');", True)
                ElseIf STATUS_ID = 17 Then
                    System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups2('" & "POPUP_TABEAN_NEW_EDIT_ESTIMATE.aspx?IDA=" & IDA & "&process_id=" & PROCESS_ID & "&TR_ID=" & TR_ID & "&IDA_LCN=" & IDA_LCN & "');", True)
                ...
                ElseIf STATUS_ID = 6 Then
                    System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups2('" & "POPUP_TABEAN_NEW_EDIT_STAFF_APPROVE.aspx?IDA=" & IDA & "&process_id=" & PROCESS_ID & "&TR_ID=" & TR_ID & "&IDA_LCN=" & IDA_LCN & "');", True)
                Else
                    System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups2('" & "POPUP_TABEAN_NEW_EDIT_STAFF_COMFIRM.aspx?IDA=" & IDA & "&process_id=" & PROCESS_ID & "&TR_ID=" & TR_ID & "&IDA_LCN=" & IDA_LCN & "');", True)
                End If
            ElseIf e.CommandName = "sel2" Then
                If STATUS_ID = 3 Or STATUS_ID = 12 Or STATUS_ID = 14 Or STATUS_ID = 17 Or STATUS_ID = 18 Or STATUS_ID = 23 Then
                    System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups2('" & "POPUP_TABEAN_NEW_EDIT_STAFF_ADD_DATA.aspx?IDA=" & IDA & "&process_id=" & PROCESS_ID & "&TR_ID=" & TR_ID & "&IDA_LCN=" & IDA_LCN & "&IDA_DR=" & IDA_DR & "&PG=1" & "');", True)
