...
Public Class POPUP_TABEAN_NEW_EDIT_STAFF_APPROVE
    ...
    Public Sub Updata_data_tabean_to_168()
        ...
        If dao_c.fields.NAME_PRODUCT_ID = True Then
            dao_tabean.fields.NAME_ENG = dao_d.fields.NAME_THAI
            dao_tabean.fields.NAME_OTHER = dao_d.fields.NAME_OTHER
            dao_tabean.fields.NAME_EXPORT = dao_d.fields.NAME_EXPORT
        End If
        ...
        If dao_c.fields.CONTAINER_PACKING_ID = True Then
            ...
            For Each dao_size.fields In dao_size.datas
                Dim dao_size_new As New DAO_TABEAN_HERB.TB_TABEAN_HERB_EDIT_REQUEST_SIZE_PACK
                dao_size_new.GetdatabyID_FK_IDA(_IDA)
...
#End Region
        ...
        'Dim ws_update As New WS_HERB.WS_DRUG
        'ws_update.XML_DRUG_BC_UPDATE_TB(NEWCODE_U, _CLS.CITIZEN_ID_AUTHORIZE) 'อัพเดทข้อมูลผ่าน sevice
    ...
    Public Sub SEND_XML(ByVal OB As Object)
        ...
        Try
            ...
            ws_fields.TR_ID = dao.fields.TR_ID 'เลขTRANSATION
