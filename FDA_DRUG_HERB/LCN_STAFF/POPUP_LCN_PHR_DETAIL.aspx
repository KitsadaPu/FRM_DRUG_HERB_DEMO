<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_LCN_PHR_DETAIL.aspx.vb" Inherits="FDA_DRUG_HERB.POPUP_LCN_PHR_DETAIL" %>
...
<table class="table">
    ...
    <tr>
        ...
        <td>
            ...
            <asp:DropDownList ID="ddl_worker_type" runat="server" AutoPostBack="True" Enabled="False"></asp:DropDownList>
        </td>
    </tr>
    <tr>
        <td align="right">เภสัชกรชั้น(ถ้ามี) :</td>
        <td>
            <asp:Label ID="txt_PHR_LEVEL" runat="server" Text=""></asp:Label>
    ...
    <tr>
        ...
        <td>
           <asp:DropDownList ID="ddl_prefix" runat="server" AutoPostBack="True" DataTextField ="thanm" DataValueField="prefixcd" Enabled="False"></asp:DropDownList>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
             <asp:Label ID="txt_PHR_TEXT_NUM" runat="server" Text=""></asp:Label>
    ...
    <tr>
        ...
        <td>
             <asp:Label ID="txt_STUDY_LEVEL" runat="server" Text=""></asp:Label>
    ...
    <tr>
        <td align="right">
            สาขา : </td>
        <td>
             <asp:Label ID="txt_PHR_VETERINARY_FIELD" runat="server" Text=""></asp:Label>
    ...
    <tr>
        ...
        <td>
             <asp:Label ID="txt_PHR_TEXT_JOB" runat="server" Text=""></asp:Label>
    ...
    <tr>
        ...
        <td >
             <asp:Label ID="txt_PHR_TEXT_WORK_TIME" runat="server" Text=""></asp:Label>
    ...
    <tr>
        ...
        <td >
            <asp:DropDownList ID="ddl_job" runat="server" Enabled="False"></asp:DropDownList>
        </td>
    </tr>
    <tr>
        <td align="right">ตามมาตรา (ถ้ามี) :</td>
        <td >
            <asp:DropDownList ID="ddl_law" runat="server" Enabled="False">
   ...
   <%-- <tr>      
        ...
        <td>
             <asp:Label ID="txt_NAME_SIMINAR" runat="server" Text=""></asp:Label>
   ...
   <%--<%-- </tr>--%>
     <%--<tr>
        <td align="right">
         ...
         <td>
             <asp:Label ID="rdp_SIMINAR_DATE" runat="server" Text=""></asp:Label>--%>
...
<%--    <tr>
 ...
 <telerik:RadGrid ID="rgns" runat="server" Width ="100%" >
