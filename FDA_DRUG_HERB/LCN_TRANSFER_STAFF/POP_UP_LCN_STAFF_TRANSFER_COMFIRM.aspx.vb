...
Public Class POP_UP_LCN_STAFF_TRANSFER_COMFIRM
    ...
    Protected Sub btn_sumit_Click(sender As Object, e As EventArgs) Handles btn_sumit.Click
        ...
        If dao.fields.STATUS_ID = 14 Then
            dao.fields.STAFF_CHECK_DATE = DATE_REQ.Text
            dao.fields.STAFF_CHECK_ID = DD_OFF_REQ.SelectedValue
            dao.fields.STAFF_CHECK_NM = DD_OFF_REQ.SelectedItem.Text
        ...
        ElseIf dao.fields.STATUS_ID = 17 Then
            dao.fields.Offer_Supervider_Date = DATE_REQ.Text
        ...
        ElseIf dao.fields.STATUS_ID = 3 Or dao.fields.STATUS_ID = 12 Then
            ...
            Blind_PDF()
        ElseIf dao.fields.STATUS_ID = 15 Or dao.fields.STATUS_ID = 9 Or dao.fields.STATUS_ID = 5 _
            Or dao.fields.STATUS_ID = 7 Or dao.fields.STATUS_ID = 13 Then
            dao.fields.CANCEL_BY = _CLS.THANM
            dao.fields.CANCEL_NAME = DD_OFF_REQ.SelectedItem.Text
            dao.fields.CANCEL_ID = DD_OFF_REQ.SelectedValue
            dao.fields.CANCEL_IDEN = _CLS.CITIZEN_ID
            dao.fields.CANCEL_NOTE = NOTE_CANCLE.Text
        ElseIf dao.fields.STATUS_ID = 11 Then
            ...
            Response.Redirect("POP_UP_LCN_STAFF_TRANSFER_EDIT.aspx?IDA=" & _IDA_TF & "&PROCESS_ID=" & _ProcessID & "&IDA_LCN=" & _IDA_LCN & "&TR_ID=" & dao.fields.TR_ID)
        End If
        dao.update()
        AddLogStatus_lcn(STATUS_ID, _ProcessID, _CLS.CITIZEN_ID, _IDA_TF, ddl_id, ddl_name)
    ...
    Sub Update_date_lcn()
        ...
        dao.GET_DATA_BY_IDA(_IDA_TF)
        Try
            dao_lcn.fields.thanm = dao.fields.TRANSFER_NM
        Catch ex As Exception
    ...
    Sub Transfer_data()
        ...
        Dim dao_log_tr As New DAO_LCN.TB_LOG_TRANSFER_LCN_HERB
        Try
            With dao_log.fields
