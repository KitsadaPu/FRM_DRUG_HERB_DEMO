        ...
        If TypeOf e.Item Is GridDataItem Then
            ...
            If e.CommandName = "HL_SELECT" Then
                If STATUS_ID = 11 Then
                    System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups2('" & " POP_UP_LCN_STAFF_TRANSFER_EDIT.aspx?IDA=" & IDA & "&PROCESS_ID=" & _PROCESS_ID & "&IDA_LCN=" & IDA_LCN & "&TR_ID=" & TR_ID & "');", True)
                Else
