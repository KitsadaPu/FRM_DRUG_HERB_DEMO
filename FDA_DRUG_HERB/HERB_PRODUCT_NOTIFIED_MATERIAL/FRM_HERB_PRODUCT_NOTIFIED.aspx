<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_NOTIFIED.Master" CodeBehind="FRM_HERB_PRODUCT_NOTIFIED.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_HERB_PRODUCT_NOTIFIED" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row" id="T1" runat="server">
        <p class="h3">คำขอเลขรับแจ้งการผลิต /นำเข้าวัตถุดิบสมุนไพร</p>
        <hr />
        <div class="row" runat="server" id="TH1">
            <div class="col-lg-10" >
            </div>
            <div class="col-lg-1" style=" text-align: left; height: 44px;">
                <asp:Button ID="btn_tb_herb" runat="server" Text="เพิ่มคำขอรับแจ้ง" Height="39px" Width="191px" />
            </div>
