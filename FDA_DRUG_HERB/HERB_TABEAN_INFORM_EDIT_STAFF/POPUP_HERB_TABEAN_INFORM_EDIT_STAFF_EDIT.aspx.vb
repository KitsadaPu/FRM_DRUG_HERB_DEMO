...
Public Class POPUP_HERB_TABEAN_INFORM_EDIT_STAFF_EDIT
    ...
    Function bind_data_uploadfile()
        ...
        End If
        dt = bao.SP_MAS_TABEAN_HERB_UPLOADFILE_BY_TYPE(240)
    ...
    Protected Sub btn_add_upload_Click(sender As Object, e As EventArgs) Handles btn_add_upload.Click
        ...
        Else
            ...
            Dim path As String = System.Configuration.ConfigurationManager.AppSettings("PATH_XML_PDF_TABEAN_INFORM_EDIT")
