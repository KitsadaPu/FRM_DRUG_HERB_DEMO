...
Public Class POPUP_HERB_TABEAN_INFORM_EDIT_CONFIRM_STAFF
    ...
    Public Sub bind_dd()
        ...
        Dim dao_sub As New DAO_TABEAN_HERB.TB_TABEAN_INFORM_EDIT
    ...
    Protected Sub btn_sumit_Click(sender As Object, e As EventArgs) Handles btn_sumit.Click
        ...
        ElseIf dao.fields.STATUS_ID = 11 Then
            ...
            Response.Redirect("POPUP_HERB_TABEAN_INFORM_EDIT_STAFF_EDIT.aspx?IDA=" & _IDA & "&process_id=" & _Process_ID & "&IDA_LCN=" & _IDA_LCN & "&TR_ID=" & _TR_ID)
    ...
    Function bind_data_uploadfile()
        ...
        Dim dao As New DAO_TABEAN_HERB.TB_TABEAN_INFORM_EDIT
        Dim STATUS_UPLOAD_ID As String = ""
        dao.GetdatabyID_IDA(_IDA)
