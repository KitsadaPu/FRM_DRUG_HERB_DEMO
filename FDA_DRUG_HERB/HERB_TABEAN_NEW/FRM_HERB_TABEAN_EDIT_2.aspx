...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-lg-10" style="background-color: beige; border-radius: 10px;">
            ...
            <div id="EDIT_UPLOAD_SHOW" runat="server">
                ...
                <div class="row" runat="server">
                    ...
                    <div class="col-lg-6" style="text-align: left">
                        <asp:TextBox ID="NOTE_EDIT" TextMode="MultiLine" runat="server" Style="height: 115px; width: 600px; background-color: beige"></asp:TextBox>
                    </div>
                    <div class="col-lg-1"></div>
                </div>
    ...
    <div id="EDIT_TB1_SHOW" runat="server" visible="false">
        <div class="row">
            <div class="col-lg-1"></div>
            <div class="col-lg-10" style="border-radius: 20px; background-color: beige">
                <div class="row">
                    <div class="col-lg-12" style="text-align: center">
