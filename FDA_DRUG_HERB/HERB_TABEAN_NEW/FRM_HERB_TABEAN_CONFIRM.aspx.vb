...
Imports System.IO
Imports FDA_DRUG_HERB.CLASS_GEN_XML
...
Public Class FRM_HERB_TABEAN_CONFIRM
    ...
    Protected Sub btn_cancel_Click(sender As Object, e As EventArgs) Handles btn_cancel.Click
        ...
        Dim url As String = ""
        url = "FRM_HERB_TABEAN_CANCEL.aspx?IDA_LCN=" & _IDA_LCN & "&PROCESS_ID_LCN=" & _PROCESS_ID_LCN &
            "&IDA_DQ=" & _IDA_Q & "&PROCESS_ID_DQ=" & _ProcessID & "&TR_ID=" & _TR_ID & "&STATUS_ID=" & status_is
