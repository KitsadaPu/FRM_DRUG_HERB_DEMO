    ...
    Private Sub RadGrid1_ItemCommand(sender As Object, e As GridCommandEventArgs) Handles RadGrid1.ItemCommand
        If TypeOf e.Item Is GridDataItem Then
            ...
            ElseIf e.CommandName = "HL3_SELECT" Then
                ...
                System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups('FRM_HERB_TABEAN_APPOINMENT.aspx?IDA_DQ=" & IDA_DQ & "&TR_ID=" & TR_ID_DQ & "&PROCESS_ID_DQ=" & PROCESS_ID_DQ & "&IDA_LCN=" & IDA_LCN & "');", True)
