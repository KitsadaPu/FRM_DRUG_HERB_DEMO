...
Public Class FRM_HERB_TABEAN_CANCEL
    ...
    Protected Sub btn_save_Click(sender As Object, e As EventArgs) Handles btn_save.Click
        ...
        Else
            dao_t.fields.STATUS_ID = _STATUS_ID
            dao_t.fields.cancel_by = _CLS.THANM
            dao_t.fields.cancel_date = Date.Now
            dao_t.fields.cancel_iden = _CLS.CITIZEN_ID
            dao_t.fields.DD_CANCEL_ID = DD_CANCEL.SelectedValue
            dao_t.fields.DD_CANCEL_NM = DD_CANCEL.SelectedItem.Text
            dao_t.fields.NOTE_CANCEL = txt_cencel_note.Text
            dao_t.Update()
            ...
            AddLogStatus(_STATUS_ID, _ProcessID, _CLS.CITIZEN_ID, _IDA)
            Response.Write("<script type='text/javascript'>parent.close_modal();</script> ")
