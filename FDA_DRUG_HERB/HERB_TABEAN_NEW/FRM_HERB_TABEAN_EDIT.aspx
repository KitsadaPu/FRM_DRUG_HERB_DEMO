<%@ Page Title="" Language="vb" MaintainScrollPositionOnPostback="true" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="FRM_HERB_TABEAN_EDIT.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_HERB_TABEAN_EDIT" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div id="EDIT_UPLOAD_SHOW" runat="server">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <asp:TextBox ID="NOTE_EDIT" TextMode="MultiLine" runat="server" Style="height: 75px; width: 600px;" ReadOnly="true"></asp:TextBox>
                </div>
                <div class="col-lg-1"></div>
            </div>
        </div>
    ...
    <div class="col-lg-1"></div>
    <hr />
    <div class="row" runat="server" visible="true" id="UPLOAD_EDIT">
    ...
    <div id="EDIT_TB1_SHOW" runat="server" visible="false">
        <div class="row">
            ...
            <div class="col-lg-10">
                ...
                <div class="row">
                    <div class="col-lg-12" style="text-align: center;">
                        <asp:TextBox ID="TXT_EDIT_NOTE_TB1" ReadOnly="true" TextMode="MultiLine" runat="server" Style="height: 50%; width: 75%; background-color: beige; border-radius: 5px;" ForeColor="#FF3300"></asp:TextBox>
                    </div>
                    <div class="col-lg-1"></div>
                </div>
            </div>
