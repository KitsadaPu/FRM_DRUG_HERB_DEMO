...
Public Class FRM_HERB_TABEAN_RENEW_STAFF
        ...
        If TypeOf e.Item Is GridDataItem Then
            ...
            If e.CommandName = "sel" Then
                If STATUS_ID = 11 Then
                    System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups2('" & "POPUP_HERB_TABEAN_RENEW_STAFF_EDIT.aspx?IDA=" & IDA & "&process_id=" & PROCESS_ID & "&IDA_DR=" & IDA_DR & "&IDA_LCN=" & IDA_LCN & "');", True)
                Else
                    System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups2('" & "POPUP_HERB_TABEAN_RENEW_CONFIRM_STAFF.aspx?IDA=" & IDA & "&process_id=" & PROCESS_ID & "&IDA_DR=" & IDA_DR & "&IDA_LCN=" & IDA_LCN & "');", True)
                End If
                'System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups2('" & "POPUP_HERB_TABEAN_RENEW_CONFIRM_STAFF.aspx?IDA=" & IDA & "&process_id=" & PROCESS_ID & "&IDA_DR=" & IDA_DR & "&IDA_LCN=" & IDA_LCN & "');", True)
