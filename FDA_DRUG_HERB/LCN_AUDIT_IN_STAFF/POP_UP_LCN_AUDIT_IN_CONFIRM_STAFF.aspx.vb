...
Public Class POP_UP_LCN_AUDIT_IN_CONFIRM_STAFF
    ...
    Protected Sub btn_sumit_Click(sender As Object, e As EventArgs) Handles btn_sumit.Click
        ...
        ElseIf dao.fields.STATUS_ID = 11 Then
            ...
            Response.Redirect("POP_UP_LCN_AUDIT_IN_STAFF_EDIT.aspx?IDA=" & _IDA & "&TR_ID=" & dao.fields.TR_ID & "&PROCESS_ID=" & _ProcessID)
    ...
    Public Sub bind_dd()
        ...
        End If
        bao.SP_MAS_STATUS_STAFF_BY_GROUP_DDL(10901, ss_id)
        dt = bao.dt
    ...
    Protected Sub btn_savefileapprove_Click(sender As Object, e As EventArgs) Handles btn_savefileapprove.Click
        ...
        RadGrid4.Rebind()
    End Sub
    Function bind_data_uploadfile_91()
        Dim dt As DataTable
        Dim bao As New BAO.ClsDBSqlcommand
        Dim Type_ID As Integer = 0
        Dim dao As New DAO_LCN.TB_DALCN_AUDIT_IN
        dao.GET_DATA_BY_IDA(_IDA)
        dt = bao.SP_DALCN_UPLOAD_FILE_BY_TR_ID_PROCESS_AND_TYPE(dao.fields.TR_ID, dao.fields.PROCESS_ID, 91)
    ...
    Private Sub RadGrid4_NeedDataSource(sender As Object, e As GridNeedDataSourceEventArgs) Handles RadGrid4.NeedDataSource
        RadGrid4.DataSource = bind_data_uploadfile_91()
    End Sub
