<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="UC_BSN_SUSTAIN_V2.ascx.vb" Inherits="FDA_DRUG_HERB.UC_BSN_SUSTAIN_V2" %>
...
<asp:Panel ID="Panel4" runat="server">
   <%-- <asp:RadioButtonList ID="rdl_type" runat="server" RepeatDirection="Horizontal" AutoPostBack="True">
    ...
    <asp:Label ID="rdl_type" runat="server" Text="โอนกิจการ"></asp:Label>
