...
Public Class POPUP_TABEAN_SUBSTITUTE_STAFF_CONFIRM
    ...
    Public Sub bind_dd()
        ...
        Dim dao_sub As New DAO_TABEAN_HERB.TB_TABEAN_HERB_SUBSTITUTE
    ...
    Protected Sub btn_sumit_Click(sender As Object, e As EventArgs) Handles btn_sumit.Click
        ...
        ElseIf dao.fields.STATUS_ID = 11 Then
            ...
            Response.Redirect("POPUP_TABEAN_SUBSTITUTE_STAFF_EDIT.aspx?IDA=" & _IDA & "&process_id=" & _Process_ID & "&IDA_LCN=" & _IDA_LCN & "&TR_ID=" & _TR_ID)
        ...
        dao.Update()
        AddLogStatus(dao.fields.STATUS_ID, _Process_ID, _CLS.CITIZEN_ID, _IDA)
        'Response.Redirect("FRM_HERB_TABEAN_JJ_EDIT_STAFF.aspx?IDA=" & _IDA & "&TR_ID=" & _TR_ID)
    ...
    Protected Sub DD_STATUS_SelectedIndexChanged(sender As Object, e As EventArgs) Handles DD_STATUS.SelectedIndexChanged
        If DD_STATUS.SelectedValue = 9 Or DD_STATUS.SelectedValue = 7 Or DD_STATUS.SelectedValue = 10 Then
            p2.Visible = True
            P12.Visible = False
        Else
            p2.Visible = False
    ...
    Protected Sub BTN_PREVIEW_Click(sender As Object, e As EventArgs) Handles BTN_PREVIEW.Click
        ...
        Dim Url As String = "FRM_TABEAN_SUBSTITUTE_STAFF_PREVIEW_DR.aspx?IDA=" & _IDA_DR & "&PROCESS_ID=" & process_id
    ...
    Public Sub Run_Pdf_Tabean_Herb_2_8()
        ...
        TBN_NEW = XML.gen_xml_tbn_2(dao.fields.IDA, _IDA_DR, _IDA_LCN)
        Dim dao_pdftemplate As New DAO_DRUG.ClsDB_MAS_TEMPLATE_PROCESS
        dao_pdftemplate.GetDataby_TEMPLAETE_and_P_ID_and_STATUS_and_PREVIEW_AND_GROUP(_Process_ID, dao_deeqt.fields.STATUS_ID, 0, 1)
