<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_TABEAN_SUBSTITUTE_STAFF_CONFIRM.aspx.vb" Inherits="FDA_DRUG_HERB.POPUP_TABEAN_SUBSTITUTE_STAFF_CONFIRM" %>
        ...
        <div class="col-lg-4" style="width: 30%">
            <div class="row" runat="server" id="KEEP_PAY" visible="true">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <asp:DropDownList ID="DD_STATUS" runat="server" DataValueField="STATUS_ID" DataTextField="STATUS_NAME" AutoPostBack="true"></asp:DropDownList>
                    </div>
                    <div class="col-lg-1"></div>
                </div>
            ...
            <div class="row" style="text-align: center">
                ...
                <div class="col-lg-10">
                    ...
                    <asp:Button ID="btn_keep_pay" runat="server" Text="ข้ามสถานะชำระเงิน" CssClass="btn-lg" Width="80%" Visible="false" />
                </div>
                <div class="col-lg-1"></div>
            </div>
            <div class="row" style="text-align: center">
                <div class="col-lg-1"></div>
                <div class="col-lg-10">
                    <asp:Button ID="BTN_PREVIEW" runat="server" Text="PREVIEW ใบสำคัญ" CssClass="btn-lg" Width="80%" Visible="false" />
                </div>
                <div class="col-lg-1"></div>
            </div>
            <hr />
