...
Public Class POPUP_TABEAN_SUBSTITUTE_STAFF_EDIT
    ...
    Sub Blind_PDF()
        ...
        dao_pdftemplate.GETDATA_TABEAN_HERB_TBN_TEMPLAETE_GROUP(_ProcessID, dao.fields.STATUS_ID, "บท", 0)
        ...
        Dim PATH_PDF_OUTPUT As String = _PATH_FILE & dao_pdftemplate.fields.PDF_OUTPUT & "\" & NAME_PDF_TBN("HB_PDF", _ProcessID, dao.fields.YEAR, dao.fields.TR_ID, _IDA, dao.fields.STATUS_ID)
        Dim Path_XML As String = _PATH_FILE & dao_pdftemplate.fields.XML_PATH & "\" & NAME_XML_TBN("HB_XML", _ProcessID, dao.fields.YEAR, dao.fields.TR_ID, _IDA, dao.fields.STATUS_ID)
    ...
    Function bind_data_uploadfile()
        ...
        End If
        Dim MAS_ID As Integer = 0
        If dao.fields.PURPOSE_ID = 1 Then
            MAS_ID = 260
        Else
            MAS_ID = 261
        End If
        dt = bao.SP_MAS_TABEAN_HERB_UPLOADFILE_BY_TYPE(MAS_ID)
    ...
    Protected Sub btn_add_upload_Click(sender As Object, e As EventArgs) Handles btn_add_upload.Click
        ...
        Else
            ...
            Dim path As String = System.Configuration.ConfigurationManager.AppSettings("PATH_XML_PDF_TABEAN_SUB")
