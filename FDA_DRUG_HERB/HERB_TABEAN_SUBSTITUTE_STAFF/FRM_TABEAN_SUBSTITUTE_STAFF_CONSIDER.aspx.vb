...
Public Class FRM_TABEAN_SUBSTITUTE_CONSIDER
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Try
            ...
            dao.fields.STATUS_ID = 5  'จ่ายเงิน
    ...
    Sub alert_reload(ByVal text As String)
        ...
        Response.Redirect("FRM_TABEAN_SUBSTITUTE_STAFF_CONFIRM.aspx?IDA=" & _IDA & "&TR_ID=" & _TR_ID)

    End Sub


    Protected Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        Response.Redirect("FRM_TABEAN_SUBSTITUTE_STAFF_CONFIRM.aspx?IDA=" & _IDA & "&TR_ID=" & _TR_ID & "&process=" & _PROCESS_ID)
    End Sub
End Class