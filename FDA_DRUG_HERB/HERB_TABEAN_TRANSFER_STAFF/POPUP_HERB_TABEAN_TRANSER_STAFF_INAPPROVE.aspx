<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_HERB_TABEAN_TRANSER_STAFF_INAPPROVE.aspx.vb" Inherits="FDA_DRUG_HERB.POPUP_HERB_TABEAN_TRANSER_STAFF_INAPPROVE" %>
        ...
        <div class="col-lg-4" style="width: 30%">
            ...
            <div class="row" runat="server" id="p2" visible="false">
                <div class="row" runat="server">
                    ...
                    <div class="col-lg-6">
                        <asp:DropDownList ID="DDL_CANCLE_REMARK" runat="server" AutoPostBack="true" DataTextField="DDL_NAME" DataValueField="DDL_ID">
                        </asp:DropDownList>
                    </div>
                    <div class="col-lg-1"></div>
                </div>
            ...
            <div class="row" style="text-align: center">
                ...
                <div class="col-lg-10">
                    ...
                    <asp:Button ID="btn_preview_tb2" runat="server" Text="Preview ทบ.2" CssClass="btn-lg" Width="80%" />
                     ...
                     <asp:Button ID="BTN_Add_Contains" runat="server" Text="เพิ่มสูตรสาร" CssClass="btn-lg" Width="80%" />
            ...
            <div class="row" runat="server">
                ...
                <div class="col-lg-6">
                    <asp:TextBox ID="TextBox1" TextMode="MultiLine" runat="server" Style="height: 20%; width: 100%"></asp:TextBox>
                </div>
                <div class="col-lg-1"></div>
            </div>
            <hr />
            <div class="row">
                <div class="col-lg-12" style="text-align: center">
                    <h3>เอกสารแนบเจ้าหน้าที่สั้งแก้ไข</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-1"></div>
            ...
            <div class="row">
                <div class="col-lg-12" style="text-align: center">
                    <h3>เอกสารแนบเจ้าหน้าที่สั้งแก้ไข(แก้ไขครั้งที่หนึ่ง)</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-1"></div>
