<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_HERB_TABEAN_TRANSER_STAFF_APPROVE.aspx.vb" Inherits="FDA_DRUG_HERB.POPUP_HERB_TABEAN_TRANSER_STAFF_APPROVE" %>
    ...
    <div class="row">
        ...
        <div class="col-lg-4" style="width: 30%">
            ...
            <div class="row" runat="server" id="uc_upload1_btn" visible="true">
                <div class="col-lg-12" style="text-align: center">
                    <asp:Button ID="btn_savefileapprove_TBN2" runat="server" Text="บันทึกแบบไฟล์" CssClass="btn-lg" Width="80%" />
                </div>
            </div>
