<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POPUP_HERB_TABEAN_TRANSER_STAFF_INOFFER.aspx.vb" Inherits="FDA_DRUG_HERB.POPUP_HERB_TABEAN_TRANSER_STAFF_INOFFER" %>
    ...
    <div class="row">
        <div class="col-lg-8" style="width: 70%">
            ...
            <div id="STAFF_KEY_SET" runat="server" style="background-color: antiquewhite">
                <br />
                <div class="row"> 
                    <div class="col-lg-12"><h3> รายระเอียดของ</h3></div>
                </div>
                <div class="row">
        ...
        <div class="col-lg-4" style="width: 30%">
            ...
            <div class="row" runat="server" id="P12" visible="false">
                ...
                <div class="row" runat="server">
                    ...
                    <div class="col-lg-6">
                        <asp:DropDownList ID="DD_ML_ID" runat="server" DataValueField="ML_ID" DataTextField="ML_NAME" AutoPostBack="true" Width="100%"></asp:DropDownList>
                    </div>
                    <div class="col-lg-1"></div>
                </div>
                <div class="row" runat="server">
