...
Public Class FRM_HERB_PRODUCT_NOTIFIED_STAFF_CONFIRM
    ...
    Public Sub bind_dd()
        ...
        Dim dao_sub As New DAO_REPORT.TB_HERB_PRODUCT_NOTIFIED
        dao_sub.Getdataby_IDA(Request.QueryString("IDA"))
    ...
    Function bind_data_uploadfile()
        ...
        Dim dao As New DAO_REPORT.TB_HERB_PRODUCT_NOTIFIED
        dao.Getdataby_IDA(_IDA)
        Dim STATUS_FILE_UPLOAD As String = ""
        If IsNothing(dao.fields.STATUS_FILE_UPLOAD) = True Then
            STATUS_FILE_UPLOAD = 0
        Else
