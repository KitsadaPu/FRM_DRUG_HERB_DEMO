<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_NOTIFIED_STAFF.Master" CodeBehind="FRM_HERB_PRODUCT_NOTIFIED_STAFF.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_HERB_PRODUCT_NOTIFIED_STAFF" %>
    ...
    <div class="panel" style="text-align: left; width: 100%">
        <div class="panel-heading panel-title" style="height: 70px">
            ...
            <div class="col-lg-4 col-md-4">
                <h4>คำขอเลขรับแจ้งการผลิต /นำเข้าวัตถุดิบสมุนไพร</h4>
            </div>
