Public Class FRM_HERB_PRODUCT_NOTIFIED_STAFF_MAIN
    ...
    Private Sub RunQuery()
        ...
        _TOKEN = "0nc9ZCvQ3WgaZxPwY3oe0wUU"
    End Sub
    ...
    Sub token()
        ...
        If code = "900" Then
            ...
            If _CLS.SYSTEM_ID = "8738" Or _CLS.SYSTEM_ID = "8734" Or _CLS.SYSTEM_ID = "9816" Then
                ...
                Response.Redirect("../HERB_PRODUCT_NOTIFIED_MATERIAL_STAFF/FRM_HERB_PRODUCT_NOTIFIED_STAFF.aspx")
            Else
                _CLS.ID_MENU = 1200
                Session("CLS") = _CLS
                Response.Redirect("../HERB_PRODUCT_NOTIFIED_MATERIAL_STAFF/FRM_HERB_PRODUCT_NOTIFIED_STAFF.aspx")
