...
Public Class POP_UP_LCN_AUDIT_OUT_STAFF_EDIT
    ...
    Private Sub load_HL(ByVal IDA As String)
        Dim url As String = "../LCN_AUDIT_IN/FRM_LCN_AUDIT_IN_PREVIEW.aspx?ida=" & IDA
    ...
    Protected Sub btn_add_upload_Click(sender As Object, e As EventArgs) Handles btn_add_upload.Click
        ...
        Else
            ...
            Dim path As String = System.Configuration.ConfigurationManager.AppSettings("PATH_XML_PDF_AUDIT")
    ...
    Private Sub RadGrid3_ItemDataBound(sender As Object, e As GridItemEventArgs) Handles RadGrid3.ItemDataBound
        If e.Item.ItemType = GridItemType.AlternatingItem Or e.Item.ItemType = GridItemType.Item Then
            ...
            H.Target = "_blank"
            H.NavigateUrl = "../LCN_AUDIT_IN/FRM_LCN_AUDIT_IN_PREVIEW.aspx?ida=" & IDA
