<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POP_UP_LCN_AUDIT_OUT_CONFIRM_STAFF.aspx.vb" Inherits="FDA_DRUG_HERB.POP_UP_LCN_AUDIT_OUT_CONFIRM_STAFF" %>
    ...
    <div class="row">
        ...
        <div class="col-lg-4" style="width: 30%">
            ...
            <hr />
             ...
             <div runat="server" id="uc_attach" visible="false">
                ...
                <div class="row" runat="server" id="uc_upload1" visible="true" style="text-align: center">
                    <div class="col-lg-1"></div>
                    <div class="col-lg-10">
                ...
                <div class="row" runat="server" id="uc_upload1_btn" visible="true" style="text-align: center">
                         <div class="col-lg-1"></div>
                    <div class="col-lg-10" >
                        <asp:Button ID="btn_savefileapprove" runat="server" Text="บันทึกแบบไฟล์" CssClass="btn-lg" Width="80%" />
                    </div>
                </div>
                <div class="row" runat="server" id="uc_upload1_radgrid" >
                    <div class="col-lg-1"></div>
