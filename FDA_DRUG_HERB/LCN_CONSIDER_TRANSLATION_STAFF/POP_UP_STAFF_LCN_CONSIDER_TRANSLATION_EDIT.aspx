<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/POPUP.Master" CodeBehind="POP_UP_STAFF_LCN_CONSIDER_TRANSLATION_EDIT.aspx.vb" Inherits="FDA_DRUG_HERB.POP_UP_STAFF_LCN_CONSIDER_TRANSLATION_EDIT" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        <div class="col-lg-2"></div>
        <div class="col-lg-5" style="padding-left: 4em">
            <asp:CheckBox ID="CHK_UPLOAD_EDIT" runat="server" AutoPostBack="True" Enabled="false"/>
