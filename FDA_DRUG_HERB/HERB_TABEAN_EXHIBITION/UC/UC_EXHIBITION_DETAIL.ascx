...
<div>
    ...
    <div class="row">
        ...
        <div class="col-lg-9">
            <asp:RadioButtonList ID="rdl_behalf_in" runat="server" AutoPostBack="true" >
                ...
                <asp:ListItem Value="8">&nbsp;ผู้รับอนุญาตนาเข้าผลิตภัณฑ์สมุนไพร</asp:ListItem>
            </asp:RadioButtonList>
        </div>
        <div class="col-lg-1"></div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-1" style="border-bottom: #999999 1px dotted;">
         ...
         <div class="col-lg-2">เพื่อการจัดนิทรรศการชื่อ</div>
        <div class="col-lg-3" style="border-bottom: #999999 1px dotted;">
    ...
    <div class="row">
        ...
        <div class="col-lg-1" style="border-bottom: #999999 1px dotted;">
            <asp:TextBox ID="txt_date_exh" runat="server" Width="87%"></asp:TextBox>
        </div>
         <div class="col-lg-2">ณ สถานที่</div>
        <div class="col-lg-3" style="border-bottom: #999999 1px dotted;">
            <asp:TextBox ID="txt_lo_exh" runat="server" Width="100%"></asp:TextBox>
        </div>
        <div class="col-lg-1"></div>
    </div>
