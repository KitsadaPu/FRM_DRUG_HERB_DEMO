...
Public Class POPUP_TABEAN_HERB_DONATE_STAFF_EDIT
    ...
    Sub Blind_PDF()
        ...
        dao_pdftemplate.GETDATA_TABEAN_HERB_JJ_TEMPLAETE1(_ProcessID, dao.fields.STATUS_ID, "บจ1", 0)
    ...
    Function bind_data_uploadfile()
        ...
        End If
        dt = bao.SP_MAS_TABEAN_HERB_UPLOADFILE_BY_TYPE(211)
    ...
    Protected Sub btn_add_upload_Click(sender As Object, e As EventArgs) Handles btn_add_upload.Click
        ...
        Else
            ...
            Dim path As String = System.Configuration.ConfigurationManager.AppSettings("PATH_XML_PDF_TABEAN_DONATE")
