...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="width: 100%; height: 500px;">
        <tr>
            <td style="width: 70%;">
                ...
                <div>
                    <table style="width: 100%">
                        ...
                        <tr>
                            <td style="width: 35%; padding-left: 15%; text-align: left">
            ...
            <td style="padding-left: 1%; height: 50%; vertical-align: top; padding-right: 5%; padding-top:5em;">
                ...
                <table class="table" style="width: 90%">
                    ...
                    <tr>
                        <td>
                            <asp:Button ID="btn_confirm" runat="server" Text="บันทึก" CssClass="btn-lg" Width="80%" /></td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            ...
                            <br />
                            <h3>เอกสารแนบ</h3>
                            <%-- <asp:Label ID="Label2" runat="server" Text="โทรสาร"></asp:Label>--%>
                        </td>
                    </tr>
                    <tr>
                        <td style="width: 100%; height: 50%; padding-left: 10%">
