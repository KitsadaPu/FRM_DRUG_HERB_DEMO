<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN.Master" CodeBehind="FRM_HERB_TABEAN_EX.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_HERB_TABEAN_EX" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="row">
        <div class="col-lg-12" style="text-align: center; top: -228px; left: -138px;">แบบแจ้งผลิตหรือนาเข้าผลิตภัณฑ์สมุนไพรเพื่อเป็นตัวอย่าง สาหรับการขึ้นทะเบียน การแจ้งรายละเอียด หรือการจดแจ้ง</div>
    </div>
    <div class="row">
        <div class="col-lg-12" style="text-align:right">
            <asp:Button ID="btn_ex_add" runat="server" Text="เพิ่มคำขอตัวอย่าง" Visible="true" />
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12">
