...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div id="EDIT_UPLOAD_SHOW" runat="server" >
        ...
        <div class="row">
            ...
            <div class="col-lg-10" style="text-align: center; color: red">
                <asp:TextBox ID="NOTE_EDIT" TextMode="MultiLine" runat="server" Style="min-height: 80px; width: 100%; border-radius: 5px" ReadOnly="true"></asp:TextBox>
            </div>
        </div>
        <%--<div class="row">
    ...
    <div id="EDIT_EX1_SHOW" runat="server" visible="false" >
        <div class="row">
            <div class="col-lg-1"></div>
            <div class="col-lg-2" style="color: red;text-align:left">
                <h3>หมายเหตุการแก้ไขข้อมูล</h3>
            </div>
            <div class="col-lg-9" style="text-align: center; color: red">
                <asp:TextBox ID="TXT_EDIT_NOTE_TB1" TextMode="MultiLine" runat="server" Style="min-height: 80px; width: 100%; border-radius: 5px;" ForeColor="#FF3300" ReadOnly="true"></asp:TextBox>
            </div>
            <div class="col-lg-1"></div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-10" style="text-align: center">
            ...
            <asp:Button ID="btn_cancel" runat="server" Text="ยกเลิก" CssClass="btn-lg" Width="10%" OnClientClick="return confirm('คุณต้องการออกจากหน้านี้หรือไม่');"/>
        </div>
        <div class="col-lg-1"></div>
    </div>
