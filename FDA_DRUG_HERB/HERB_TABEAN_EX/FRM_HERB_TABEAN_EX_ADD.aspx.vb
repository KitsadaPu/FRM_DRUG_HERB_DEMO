...
Public Class FRM_HERB_TABEAN_EX_ADD
    ...
    Protected Sub btn_save_Click(sender As Object, e As EventArgs) Handles btn_save.Click
        ...
        Else
            ...
            End Try
            If dao_lcn.fields.PROCESS_ID = 121 Then
                dao_ex.fields.FOREIGN_NAME = striptags(txt_search.Text)
                dao_ex.fields.FOREIGN_NAME_ID = PLACE_IDA
                dao_ex.fields.FOREIGN_NAME_PLACE = txt_address.Text.ToUpper()
                dao_ex.fields.FOREIGN_NAME_PLACE_ID = IDA_ADDRESS
            End If
    ...
    Sub alert_summit(ByVal text As String)
        Dim url As String = ""
        url = "FRM_HERB_TABEAN_EX_UPLOAD_FILE.aspx?&IDA_LCN=" & _IDA_LCN & "&IDA_EX=" & _IDA_EX & "&PROCESS_ID=" & _PROCESS_ID
    ...
    Sub sum(ByVal IDA As Integer)
        Try
            ...
            txt_quantity_produced.Text = sum_pagkage & " " & dao_packsize.fields.UNIT_F_NAME
    ...
    Private Sub bind_package_size()
        ...
        dt = bao.SP_DRSAMP_PACKAGE_SIZE(_IDA_EX)
    ...
    Protected Sub btn_search_Click(sender As Object, e As EventArgs) Handles btn_search.Click
        Search_frgn()
        'RadGrid1.Rebind()
        Panel_FRGN.Style.Add("display", "block")
        Panel_FRGN_ADDR.Style.Add("display", "block")
    End Sub
    ...
    Sub Search_frgn()
        ...
        RG_FRGN.DataSource = dt
    End Sub

    Private Sub RG_FRGN_NeedDataSource(sender As Object, e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles RG_FRGN.NeedDataSource
        If txt_search.Text <> "" Then
            Search_frgn()
        End If
    End Sub

    Private Sub RG_FRGN_ItemCommand(sender As Object, e As Telerik.Web.UI.GridCommandEventArgs) Handles RG_FRGN.ItemCommand
        If TypeOf e.Item Is GridDataItem Then
            Dim item As GridDataItem = e.Item
            ...
            If e.CommandName = "sel" Then
                ...
                RG_FRGN_ADDR.DataSource = dt
                RG_FRGN_ADDR.Rebind()
            End If
            'Panel_FRGN.Style.Add("display", "none")
        End If
        Panel_FRGN.Style.Add("display", "none")
    End Sub
    Private Sub RG_FRGN_ADDR_ItemCommand(sender As Object, e As GridCommandEventArgs) Handles RG_FRGN_ADDR.ItemCommand
        If TypeOf e.Item Is GridDataItem Then
            Dim item As GridDataItem = e.Item
            If e.CommandName = "sel" Then
            ...
            End If
            Panel_FRGN_ADDR.Style.Add("display", "none")
        End If
    End Sub
    Public Function striptags(ByVal html As String) As String
        Return Regex.Replace(html, "\s", "")
