...
Public Class FRM_HERB_TABEAN_NEW_EDIT
        ...
        If TypeOf e.Item Is GridDataItem Then
            ...
            If e.CommandName = "sel" Then
                ...
                ElseIf STATUS_ID = 11 Or STATUS_ID = 16 Then
                    System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups('" & "POPUP_HERB_TABEAN_NEW_EDIT_UPLOAD_EDIT.aspx?IDA_LCT=" &
                                                                      IDA_LCN & "&TR_ID_LCN=" & TR_ID_LCN & "&IDA_DR=" & _IDA_DR & "&IDA_LCN=" & _IDA_LCN & "&PROCESS_ID=" & _PROCESS_ID & "&IDA=" & IDA & "&TR_ID=" & TR_ID & "&staff=" & Request.QueryString("staff") & "');", True)
                Else
                    System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups('" & "POPUP_HERB_TABEAN_NEW_EDIT_CONFIRM.aspx?IDA_LCT=" &
                                                                     IDA_LCN & "&TR_ID_LCN=" & TR_ID_LCN & "&IDA_DR=" & _IDA_DR & "&IDA_LCN=" & _IDA_LCN & "&PROCESS_ID=" & _PROCESS_ID & "&IDA=" & IDA & "&TR_ID=" & TR_ID & "&staff=" & Request.QueryString("staff") & "');", True)
    ...
    Private Sub RadGrid1_ItemDataBound(sender As Object, e As GridItemEventArgs) Handles RadGrid1.ItemDataBound
        If e.Item.ItemType = GridItemType.AlternatingItem Or e.Item.ItemType = GridItemType.Item Then
            ...
            'H.Target = "_blank"
            'H.NavigateUrl = urls
            If STATUS_ID = 11 Or STATUS_ID = 16 Then
                btn_Select.Text = "แก้ไข"
            End If
            If STATUS_ID = 3 Then
    ...
    Protected Sub btn_add_Click(sender As Object, e As EventArgs) Handles btn_add.Click
        ...
        System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups2('" & "POPUP_HERB_TABEAN_NEW_EDIT_ADD.aspx?IDA_DR=" & _IDA_DR & "&IDA_LCN=" & _IDA_LCN & "&PROCESS_ID=" & _PROCESS_ID & "&staff=" & Request.QueryString("staff") & "&Newcode=" & _Newcode & "');", True)
    End Sub
End Class