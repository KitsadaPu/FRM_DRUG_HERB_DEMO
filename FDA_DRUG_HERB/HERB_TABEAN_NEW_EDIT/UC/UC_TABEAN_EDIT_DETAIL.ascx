...
<div class="row">
    <div class="col-lg-12" style="padding-left: 2em; padding-right: 2em">
        ...
        <asp:Panel ID="Panel2" runat="server" Style="display: none;">
            ...
            <div class="row">
                <div class="col-lg-6" style="text-align: left">
                    <h2>ชื่อหรือที่อยู่ของสถานที่ผลิต/ นำเข้ำ</h2>
                    <hr />
                </div>
            </div>
            ...
            <div runat="server" id="Div_check1_2" visible="false">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <asp:Button ID="Btn_ResetData" runat="server" Text="ดึงข้อมูลใบอนุญาติใหม่" />
                    </div>
                </div>
        ...
        <asp:Panel ID="Panel5" runat="server" Style="display: none;">
            <div class="row">
                <div class="col-lg-6" style="text-align: left">
                    <h2>สรรพคุณ/ข้อบ่งใช้/ข้อความกล่าวอ้างทางสุขภาพ</h2>
                    <hr />
                </div>
            </div>
            <div class="row" style="height: 5px"></div>
        ...
        <asp:Panel ID="Panel9" runat="server" Style="display: none;">
            <div class="row">
                <div class="col-lg-6" style="text-align: left">
                    <h2>การเก็บรักษา/อายุการเก็บรักษา</h2>
                    <hr />
                </div>
            </div>
            <div class="row" style="height: 5px"></div>
        ...
        <asp:Panel ID="Panel11" runat="server" Style="display: none;">
            ...
            <div class="row">
                <div class="col-lg-6" style="text-align: left">
                    <h2>วิธีควบคุมคุณภาพและข้อกำหนดเฉพาะของผลิตภัณฑ์สมุนไพร</h2>
                    <hr />
                    <div class="row">
                        <div class="col-lg-1"></div>
                        <div class="col-lg-8" style="color: red">
        ...
        <asp:Panel ID="Panel12" runat="server" Style="display: none;">
            ...
            <div class="row">
                <div class="col-lg-6" style="text-align: left">
                    <h2>หนังสือรับรองการอนุญาตให้ขายหรือการขึ้นทะเบียนตำรับผลิตภัณฑ์สมุนไพร เฉพาะกรณีที่เป็นการนำเข้ำ</h2>
                    <hr />
                </div>
            </div>
        </asp:Panel>
        <asp:Panel ID="Panel13" runat="server" Style="display: none;">
            ...
            <div class="row">
                <div class="col-lg-6" style="text-align: left">
                    <h2>ฉลาก และเอกสารกำกับผลิตภัณฑ์สมุนไพร</h2>
                    <hr />
                </div>
            </div>
