Public Class UC_TABEAN_EDIT_SELECT_LIST
    ...
    Sub SAVE_DATA()
        ...
        If dao.fields.IDA = 0 Then
            ...
            dao.fields.SIZE_USE_ID = CB_SIZE_PACK_ID.Checked
    ...
    Sub INSERT_FILEUPLOAD(ByVal TR_ID As Integer)
        ...
        If CB_SIZE_PACK_ID.Checked = True Then
    ...
    Protected Sub CB_SIZE_PACK_ID_CheckedChanged(sender As Object, e As EventArgs) Handles CB_SIZE_PACK_ID.CheckedChanged
        If CB_SIZE_PACK_ID.Checked = True Then
            CB_ETIQUETQ_ID.Enabled = True
            CB_NAME_PRODUCT_ID.Enabled = False
            CB_NAME_LOCATION_ID.Enabled = False
