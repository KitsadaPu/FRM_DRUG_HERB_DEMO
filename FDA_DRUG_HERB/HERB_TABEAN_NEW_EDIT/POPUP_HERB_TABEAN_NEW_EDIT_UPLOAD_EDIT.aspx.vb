...
Public Class POPUP_HERB_TABEAN_NEW_EDIT_UPLOAD_EDIT
    ...
    Private Function check_file()
        ...
        dao_check.GetdatabyID_TR_ID_PROCESS_ID_ALL(TR_ID, _ProcessID, 3)
    ...
    Sub BIND_PDF_TABEAN()
        ...
        dao_pdftemplate.GETDATA_TABEAN_HERB_JJ_TEMPLAETE1(_ProcessID, dao.fields.STATUS_ID, "ทบ3", 0)
