<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Main_PPK.Master" CodeBehind="FRM_HERB_TABEAN_NEW_EDIT_MAIN_NEW.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_HERB_TABEAN_NEW_EDIT_MAIN_NEW" %>
   ...
   <%-- <div class="row">
        ...
        <div class="col-lg-6" style="width: 40%; text-align: center">
            <asp:DropDownList ID="DD_DRRGT_PROCESS_ID" runat="server" AutoPostBack="true">
                ...
                <asp:ListItem Value="20710">การขอต่ออายุใบสำคัญการขึ้นทะเบียนผลิตภัณฑ์สมุนไพร</asp:ListItem>
                <asp:ListItem Value="20720">การขอต่ออายุใบรับแจ้งรายละเอียดผลิตภัณฑ์สมุนไพร</asp:ListItem>
                <asp:ListItem Value="20730">การขอต่ออายุใบรับจดแจ้งรายละเอียดผลิตภัณฑ์สมุนไพร</asp:ListItem>
            </asp:DropDownList>
        </div>
        <div class="col-lg-1"></div>
    </div>--%>
    <div class="row" runat="server" id="TB1" >
