<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN_STAFF.Master" CodeBehind="FRM_HERB_NOTIFY_CORRECTION_STAFF.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_HERB_NOTIFY_CORRECTION_STAFF" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel" style="text-align: left; width: 100%">
        <div class="panel-heading panel-title" style="height: 70px">
            ...
            <div class="col-lg-10">
                <h4>หนังสือแจ้งการแก้ไขรายการในใบสำคัญการขึ้นทะเบียน</h4>
            </div>
        </div>
    </div>
