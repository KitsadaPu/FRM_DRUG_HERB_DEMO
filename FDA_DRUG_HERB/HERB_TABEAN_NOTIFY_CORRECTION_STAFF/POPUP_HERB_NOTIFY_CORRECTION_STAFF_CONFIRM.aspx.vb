...
Public Class POPUP_HERB_NOTIFY_CORRECTION_STAFF_CONFIRM
    ...
    Sub BIND_PDF_TABEAN()
        ...
        Dim XML As New CLASS_GEN_XML.TABEAN_NOTIFY_EDIT
        TBN_NOTIFY = XML.GEN_XML_NOTIFY_EDIT(_IDA)

        Dim dao_pdftemplate As New DAO_DRUG.ClsDB_MAS_TEMPLATE_PROCESS
        dao_pdftemplate.GETDATA_TABEAN_HERB_JJ_TEMPLAETE1(_Process_ID, dao.fields.STATUS_ID, "จก", 0)

        Dim _PATH_FILE As String = System.Configuration.ConfigurationManager.AppSettings("PATH_XML_PDF_TABEAN_NOTIFY_EDIT") 'path
    ...
    Public Sub bind_dd()
        ...
        dt = Get_DDL_DATA(214, int_group_ddl1, int_group_ddl2)
    ...
    Protected Sub btn_sumit_Click(sender As Object, e As EventArgs) Handles btn_sumit.Click
        ...
        If dao.fields.STATUS_ID = 3 Or dao.fields.STATUS_ID = 10 Then
        ...
        ElseIf dao.fields.STATUS_ID = 11 Then
            ...
            Response.Redirect("POPUP_HERB_NOTIFY_CORRECTION_STAFF_EDIT.aspx?IDA=" & _IDA & "&process_id=" & _Process_ID & "&IDA_LCN=" & _IDA_LCN & "&TR_ID=" & dao.fields.TR_ID)
    ...
    Private Sub RadGrid1_ItemDataBound(sender As Object, e As GridItemEventArgs) Handles RadGrid1.ItemDataBound
        If e.Item.ItemType = GridItemType.AlternatingItem Or e.Item.ItemType = GridItemType.Item Then
            ...
            H.Target = "_blank"
            H.NavigateUrl = "../HERB_TABEAN_NOTIFY_CORRECTION/FRM_HERB_NOTIFY_CORRECTION_PREVIEW.aspx?ida=" & IDA
