...
Public Class POPUP_HERB_NOTIFY_CORRECTION_STAFF_EDIT
    ...
    Sub Blind_PDF()
        ...
        dao_pdftemplate.GETDATA_TABEAN_HERB_JJ_TEMPLAETE1(_ProcessID, dao.fields.STATUS_ID, "จก", 0)
    ...
    Function bind_data_uploadfile()
        ...
        End If
        dt = bao.SP_MAS_TABEAN_HERB_UPLOADFILE_BY_TYPE(212)
    ...
    Protected Sub btn_add_upload_Click(sender As Object, e As EventArgs) Handles btn_add_upload.Click
        ...
        Else
            ...
            Dim path As String = System.Configuration.ConfigurationManager.AppSettings("PATH_XML_PDF_TABEAN_NOTIFY_EDIT")
            UC_ATTACH_LCN.ATTACH_TABEAN(dao.fields.TR_ID, 0, dao.fields.PROCESS_ID, Year, "3", path)
    ...
    Function bind_data_uploadfile_4()
        ...
        Dim bao As New BAO_TABEAN_HERB.tb_main
        dt = bao.SP_TABEAN_HERB_UPLOAD_FILE_JJ_FK_IDA_LCN_V2(_TR_ID, 2, _ProcessID, 0)
