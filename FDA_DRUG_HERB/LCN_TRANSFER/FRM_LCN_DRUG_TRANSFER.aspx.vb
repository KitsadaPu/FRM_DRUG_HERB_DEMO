        ...
        If TypeOf e.Item Is GridDataItem Then
            ...
            If e.CommandName = "HL_SELECT" Then
                ...
                If STATUS_ID = 11 Then
                    ...
                    System.Web.UI.ScriptManager.RegisterStartupScript(Page, GetType(Page), "ใส่ไรก็ได้", "Popups2('" & " POPUP_LCN_TRANSFER_EDIT.aspx?IDA=" & IDA & "&PROCESS_ID=" & PROCESS_ID & "&IDA_LCN=" & IDA_LCN & "&staff=" & Request.QueryString("staff") & "');", True)
                Else
                    lbl_head1.Text = "รายละเอียดคำขอ"
