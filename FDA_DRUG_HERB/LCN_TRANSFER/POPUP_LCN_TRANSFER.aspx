...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-lg-2">
            ...
            <asp:Label ID="lbl_bsn_name" runat="server" Text="ซึ่งมีผู้ดำเนินกิจการ"></asp:Label>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-5" style="text-align: left">
            ...
            <asp:Label ID="lbl_transfer_infor" runat="server" Text="*กรณีผู้รับโอนเป็นนิติบุคคลกรุณากรอกเลขนิติบุคคล กรณีผู้รับโอนเป็นบุคคลกรุณากรอกเลขบัตรประชาชน" ForeColor="Red" Font-Size="Smaller"></asp:Label>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-1"></div>
    ...
    <div class="row">
        <div class="col-lg-1"></div>
        <div class="col-lg-10">
            <asp:Label ID="Label3" runat="server" Text="ข้าพเจ้า (ผู้โอน) ขอส่งคืนใบอนุญาตและขอยกเลิกใบอนุญาตฯ ของข้าพเจ้า นับตั้งแต่ผู้รับโอนได้รับอนุญาตจากผู้รับอนุญาต"></asp:Label>
        </div>
        <div class="col-lg-1"></div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-1"></div>
        <div class="col-lg-10">
            <asp:CheckBox ID="CHK_Agree" runat="server" AutoPostBack="True" />&ensp; <asp:Label ID="Label1" runat="server" Text="ยินยอม"></asp:Label>
               <br />
            <label >ยินยอมตามข้างต้น และจะส่งคืนใบอนุญาตฯ ให้ภายใน 10 วันหลังจากยื่นคำขอ หากสำนักงานคณะกรรมการอาหารและยา/ สำนักงานสาธารณสุข (แล้วแต่กรณี) ไม่ได้รับใบอนุญาตฯ ภายในระยะเวลาที่กำหนด ข้าพเจ้ายินดียกเลิกคำขอโอนใบอนุญาตฯ</label>
            <br />
            <label id="lbl_check" runat="server" visible="false" style="color:red">*โปรดอ่านรายละเอียด ก่อนกดยินยอมเพื่อทำรายการต่อ</label>
        </div>
        <div class="col-lg-1"></div>
    </div>
