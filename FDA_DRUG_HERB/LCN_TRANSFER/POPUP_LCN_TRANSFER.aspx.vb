Public Class POPUP_LCN_TRANSFER
    ...
    Private Sub btn_search_Click(sender As Object, e As EventArgs) Handles btn_search.Click
        ...
        'Else
        '    Try
        '        operator_name.Text = ws_taxno.SYSLCNSNMs.thanm & " " & ws_taxno.SYSLCNSNMs.thalnm
        '    Catch ex As Exception
    ...
    Protected Sub Confirm_Click(sender As Object, e As EventArgs) Handles btn_Confirm.Click
        ...
        If CHK_Agree.Checked = True Then
            ...
            dao.fields.BSN_IDENTIFY = txt_ctzid.Text
            dao.fields.TRANSFER_DATE = CDate(RPD_start_trnf.SelectedDate)
            ...
            dao.fields.CHK_Agree = CHK_Agree.Checked
            Try
