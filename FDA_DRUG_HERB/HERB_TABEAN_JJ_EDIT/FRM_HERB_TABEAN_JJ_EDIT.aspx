<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Main_PPK.Master" CodeBehind="FRM_HERB_TABEAN_JJ_EDIT.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_HERB_TABEAN_JJ_EDIT1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-body" style="width: 100%; height: 780px; padding-left: 1em">
        ...
        <%--    </div>--%>
         ...
         <div class="row" style="padding-top: 3px"></div>
        <div style="width: 100%; padding-left: 1%;">
            ...
            <div class="h5" style="padding-left: 92%;">
