...
Public Class FRM_HERB_TABEAN_JJ_CONFIRM
    ...
    Protected Sub btn_confirm_Click(sender As Object, e As EventArgs) Handles btn_confirm.Click
        If txt_ref_no.Text <> "" Then
            ...
            ' alert("ยื่นคำขอแล้ว")
            Response.Redirect("FRM_HERB_TABEAN_JJ_CONFIRM_DETAIL.aspx?IDA_LCT=" & _IDA_LCT & "&TR_ID_LCN=" & _TR_ID_LCN & "&MENU_GROUP=" & _MENU_GROUP & "&IDA_LCN=" & _IDA_LCN & "&DD_HERB_NAME_ID=" & _DD_HERB_NAME_ID & "&PROCESS_JJ=" & _ProcessID & "&IDA=" & _IDA & "&PROCESS_ID_LCN=" & _PROCESS_ID_LCN & "&TR_ID=" & _TR_ID & "&OPF=" & Request.QueryString("OPF"))
        End If
    ...
    Protected Sub btn_edit_Click(sender As Object, e As EventArgs) Handles btn_edit.Click
        'Dim dao As New DAO_TABEAN_HERB.TB_TABEAN_JJ
        'dao.GetdatabyID_IDA(_IDA)
        Response.Redirect("FRM_HERB_TABEAN_JJ_EDIT_REQUEST.aspx?IDA_LCT=" & _IDA_LCT & "&TR_ID_LCN=" & _TR_ID_LCN & "&MENU_GROUP=" & _MENU_GROUP & "&IDA_LCN=" & _IDA_LCN & "&DD_HERB_NAME_ID=" & _DD_HERB_NAME_ID & "&PROCESS_JJ=" & _ProcessID & "&PROCESS_ID_LCN=" & _PROCESS_ID_LCN & "&IDA=" & _IDA & "&OPF=" & Request.QueryString("OPF"))
    End Sub
    ...
    Sub alert_EditUp(ByVal text As String)
        Dim url As String = ""
        url = "FRM_HERB_TABEAN_JJ_ADD_DETAIL_UPLOAD_FILE_EDIT.aspx?IDA_LCT=" & _IDA_LCT & "&TR_ID_LCN=" & _TR_ID_LCN & "&MENU_GROUP=" & _MENU_GROUP & "&IDA_LCN=" & _IDA_LCN & "&DD_HERB_NAME_ID=" & _DD_HERB_NAME_ID & "&PROCESS_JJ=" & _ProcessID & "&IDA=" & _IDA & "&PROCESS_ID_LCN=" & _PROCESS_ID_LCN & "&OPF=" & Request.QueryString("OPF")
    ...
    Protected Sub btn_editUpload_Click(sender As Object, e As EventArgs) Handles btn_editUpload.Click
        ...
        Response.Redirect("FRM_HERB_TABEAN_JJ_ADD_DETAIL_UPLOAD_FILE_EDIT.aspx?IDA_LCT=" & _IDA_LCT & "&TR_ID_LCN=" & _TR_ID_LCN & "&MENU_GROUP=" & _MENU_GROUP & "&IDA_LCN=" & _IDA_LCN & "&DD_HERB_NAME_ID=" & _DD_HERB_NAME_ID & "&PROCESS_JJ=" & _ProcessID & "&IDA=" & _IDA & "&PROCESS_ID_LCN=" & _PROCESS_ID_LCN & "&OPF=" & Request.QueryString("OPF"))
    End Sub
