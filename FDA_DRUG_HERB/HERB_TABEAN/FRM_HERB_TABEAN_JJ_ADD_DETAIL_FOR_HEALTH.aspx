<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN.Master" CodeBehind="FRM_HERB_TABEAN_JJ_ADD_DETAIL_FOR_HEALTH.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_HERB_TABEAN_JJ_ADD_DETAIL_FOR_HEALTH" %>
...
<%--    <div class="row">
        ...
        <div class="col-lg-8" style="border-bottom: #999999 1px dotted">
        <asp:DropDownList ID="DD_HOW_USE" runat="server" DataValueField="HOW_USE_ID" DataTextField="HOW_USE_NAME" BackColor="White" Height="25px" Width="100%" SkinID="bootstrap">
            </asp:DropDownList>
        </div>
        <div class="col-lg-1"></div>
    </div>--%>
