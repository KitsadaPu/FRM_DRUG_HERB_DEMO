<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/MAIN.Master" CodeBehind="FRM_HERB_TABEAN_JJ_CONFIRM1.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_HERB_TABEAN_JJ_CONFIRM" %>
    ...
    <div class="row">
        ...
        <div class="col-lg-4" style="width: 30%">
            ...
            <div class="row" style="text-align: center">
                ...
                <div class="col-lg-10">
                    <asp:Button ID="btn_confirm" runat="server" Text="ส่งเรื่อง" CssClass="btn-lg" Width="80%" OnClientClick="return confirm('คุณต้องการบันทึกข้อมูลหรือไม่');"/>
