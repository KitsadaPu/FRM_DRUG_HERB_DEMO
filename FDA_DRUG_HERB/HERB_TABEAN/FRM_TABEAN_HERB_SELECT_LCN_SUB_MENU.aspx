<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage/Main_PPK.Master" CodeBehind="FRM_TABEAN_HERB_SELECT_LCN_SUB_MENU.aspx.vb" Inherits="FDA_DRUG_HERB.FRM_TABEAN_HERB_SELECT_LCN_SUB_MENU" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel" style="text-align: left; width: 100%" runat="server" id="panel1" visible="false">
