...
Public Class UC_TABEAN_JJ_DETAIL_CAS
    ...
    Private Sub btn_up_Click(sender As Object, e As EventArgs) Handles btn_up.Click
        ...
        For Each item As GridDataItem In rg_chem.SelectedItems
            Dim dao_curr As New DAO_TABEAN_HERB.TB_TABEAN_JJ_DETAIL_CAS
            Dim dao_max As New DAO_TABEAN_HERB.TB_TABEAN_JJ_DETAIL_CAS
            Dim dao_min As New DAO_TABEAN_HERB.TB_TABEAN_JJ_DETAIL_CAS
            Dim dao_rowup As New DAO_TABEAN_HERB.TB_TABEAN_JJ_DETAIL_CAS
