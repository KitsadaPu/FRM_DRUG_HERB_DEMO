...
Public Class FRM_HERB_TABEAN_JJ_SELECT_LCN
    ...
    Private Sub RadGrid1_ItemDataBound(sender As Object, e As GridItemEventArgs) Handles RadGrid1.ItemDataBound
        If e.Item.ItemType = GridItemType.AlternatingItem Or e.Item.ItemType = GridItemType.Item Then
            ...
            H.NavigateUrl = "../HERB_TABEAN/FRM_HERB_TABEAN_JJ.aspx?TR_ID_LCN=" & TR_ID_LCN & "&MENU_GROUP=" & _MENU_GROUP & "&IDA_LCN=" & IDA_LCN & "&PROCESS_ID_LCN=" & PROCESS_ID & "&SID=" & _SID 'URL หน้า ยืนยัน
