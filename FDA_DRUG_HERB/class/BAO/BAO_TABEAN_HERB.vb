...
Namespace BAO_TABEAN_HERB
    ...
    Public Class tb_dd
        ...
        Public Function SP_DD_MAS_TABEAN_HERB_HEALTH_NAME_JJ() As DataTable
            ...
            Return dt
        End Function
        'Public Function SP_DD_MAS_TABEAN_HERB_HEALTH_NAME_JJ(ByVal P_ID As Integer) As DataTable
        '    Dim dt As New DataTable
        '    Dim qstr As String = ""

        '    qstr = "exec SP_DD_MAS_TABEAN_HERB_HEALTH_NAME_JJ @PROCESS_ID=" & P_ID
        '    dt = Queryds(qstr)
        ...
        Public Function SP_MAS_DDL_SECTION_CANCEL() As DataTable
            ...
            Return dt
        End Function
        Public Function SP_DRRQT_GET_RGTNO_BY_RGTTPCD_TBN(ByVal rgttpcd As String, ByVal YEAR As Integer) As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_DRRQT_GET_RGTNO_BY_RGTTPCD_TBN @rgttpcd=" & rgttpcd & ",@year=" & YEAR
            dt = Queryds(qstr)
        ...
        Public Function SP_MAS_TABEAN_HERB_ML() As DataTable
            ...
            Return dt
        End Function
        Public Function SP_DDL_TABEAN_HERB_BY_IDEN(ByVal IDEN As String) As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_DDL_TABEAN_HERB_BY_IDEN @IDEN= '" & IDEN & "'"
            dt = Queryds(qstr)
    ...
    Public Class tb_main
        ...
        Public Function SP_DRUG_DRRQT_MAIN_STAFF_NEW() As DataTable
            ...
            Return dt
        End Function
        Public Function SP_TRANSFER_DRR_TO_TABEAN_HERB(ByVal IDA As String) As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_TRANSFER_DRR_TO_TABEAN_HERB @IDA=" & IDA
            dt = Queryds(qstr)
        ...
        Public Function SP_MAS_FORBIDDEN_WORD_THAI(ByVal WORD As String) As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_MAS_FORBIDDEN_WORD_THAI @WORD= '" & WORD & "'"
            dt = Queryds(qstr)

            Return dt
        End Function
        Public Function SP_MAS_FORBIDDEN_WORD_ENG(ByVal WORD As String) As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_MAS_FORBIDDEN_WORD_ENG @WORD= '" & WORD & "'"
            dt = Queryds(qstr)
        ...
        Public Function SP_TABEAN_JJ(ByVal IDA_LCN As String) As DataTable
            ...
            Return dt
        End Function
        Public Function SP_DALCN_PHR_CUSTOMER(ByVal IDEN As String) As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_DALCN_PHR_CUSTOMER @IDEN= '" & IDEN & "'"
            dt = Queryds(qstr)

            Return dt
        End Function
        Public Function SP_DALCN_PHR_STAFF_BY_PVNCD(ByVal PVNCD As String) As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_DALCN_PHR_STAFF_BY_PVNCD @PVNCD= '" & PVNCD & "'"
            dt = Queryds(qstr)

            Return dt
        End Function
        Public Function SP_DALCN_PHR_STAFF() As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_DALCN_PHR_STAFF"
            dt = Queryds(qstr)

            Return dt
        End Function
        Public Function SP_DALCN_AUDIT_OUT_STAFF() As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_DALCN_AUDIT_OUT_STAFF"
            dt = Queryds(qstr)

            Return dt
        End Function
        Public Function SP_DALCN_AUDIT_IN_STAFF() As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_DALCN_AUDIT_IN_STAFF"
            dt = Queryds(qstr)
        ...
        Public Function SP_DALCN_PHR_CUSTOMER_ADDR(ByVal FK_IDA As String) As DataTable
            ...
            Return dt
        End Function
        Public Function SP_DALCN_PHR_BY_IDENTIFY(ByVal Identify As String) As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""
            ...
            Return dt
        End Function
        Public Function SP_DALCN_AUDIT_DETAIL_GROUP_DRUG(ByVal FK_IDA As Integer, ByVal PROCESS_ID As String) As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_DALCN_AUDIT_DETAIL_GROUP_DRUG @FK_IDA= '" & FK_IDA & "' " & ",@Process='" & PROCESS_ID & "'"
            dt = Queryds(qstr)
        ...
        Public Function SP_MAS_TABEAN_HERB_EDIT_UPLOADFILE(ByVal FK_IDA As Integer) As DataTable
            ...
            Return dt
        End Function
        Public Function SP_DALCN_AUDIT_DETAIL_GROUP_DRUG_BY_ID(ByVal FK_IDA As Integer, ByVal PROCESS_ID As String, ByVal ID As String) As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_DALCN_AUDIT_DETAIL_GROUP_DRUG_BY_ID @FK_IDA= '" & FK_IDA & "' " & ",@Process='" & PROCESS_ID & "'" & ",@ID='" & ID & "'"
            dt = Queryds(qstr)

            Return dt
        End Function
        Public Function SP_TABEAN_JJ_WHO(ByVal IDA_LCN As String, ByVal CITIEN_ID As String) As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_TABEAN_JJ_WHO @IDA_LCN= '" & IDA_LCN & "' " & ",@CITIZEN_ID='" & CITIEN_ID & "'"
            dt = Queryds(qstr)
        ...
        Public Function SP_XML_TABEAN_JJ_EDIT_REQUEST(ByVal IDEN As String, ByVal FK_IDA As Integer) As DataTable
            ...
            Return dt
        End Function
        Public Function SP_TABEAN_INFORM_EDIT_BY_FK_IDEN(ByVal IDEN As String) As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_TABEAN_INFORM_EDIT_BY_FK_IDEN @IDENTIFY= '" & IDEN & "'"
            dt = Queryds(qstr)

            Return dt
        End Function
        Public Function SP_TABEAN_INFORM_EDIT_BY_FK_IDEN_AND_LCN(ByVal IDEN As String, ByVal FK_LCN As Integer) As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_TABEAN_INFORM_EDIT_BY_FK_IDEN_AND_LCN @IDENTIFY= '" & IDEN & "'" & ",@FK_LCN=" & FK_LCN
            dt = Queryds(qstr)
        ...
        Public Function SP_TABEAN_RENEW_TBN_CUSTOMER(ByVal IDEN As String, ByVal FK_IDA As Integer) As DataTable
            ...
            Return dt
        End Function
        Public Function SP_TABEAN_HERB_TRANSFER_BY_IDEN(ByVal IDEN As String) As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_TABEAN_HERB_TRANSFER_BY_IDEN @IDEN= '" & IDEN & "'"
            dt = Queryds(qstr)

            Return dt
        End Function

        Public Function SP_TABEAN_HERB_TRANSFER_STAFF() As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_TABEAN_HERB_TRANSFER_STAFF"
            dt = Queryds(qstr)

            Return dt
        End Function
        Public Function SP_HERB_REPORT_MAIN_STAFF_BY_FK_IDA_LCN() As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_HERB_REPORT_MAIN_STAFF_BY_FK_IDA_LCN"
            dt = Queryds(qstr)

            Return dt
        End Function

        Public Function SP_TABEAN_NOTIFY_CORRECTION_CUSTOMER(ByVal IDEN As String) As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_TABEAN_NOTIFY_CORRECTION_CUSTOMER @IDENTIFY= '" & IDEN & "'"
            dt = Queryds(qstr)
        ...
        Public Function SP_XML_TABEAN_RENEW_TBN(ByVal FK_IDA As Integer) As DataTable
            ...
            Return dt
        End Function
        Public Function SP_TABEAN_EDIT_REQUEST_BY_IDA(ByVal IDA As Integer) As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_TABEAN_EDIT_REQUEST_BY_IDA @IDA=" & IDA
            dt = Queryds(qstr)
        ...
        Public Function SP_XML_TABEAN_EDIT_REQUEST_CHK_LIST(ByVal IDA As Integer) As DataTable
            ...
            Return dt
        End Function
        Public Function SP_XML_TABEAN_INFORM_EDIT(ByVal IDA As Integer) As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_XML_TABEAN_INFORM_EDIT @IDA=" & IDA
            dt = Queryds(qstr)
        ...
        Public Function SP_XML_TABEAN_HERB_SUBSTITUTE(ByVal IDA As Integer) As DataTable
            ...
            Return dt
        End Function
        Public Function SP_XML_TABEAN_HERB_NOTIFY_EDIT(ByVal IDA As Integer) As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_XML_TABEAN_HERB_NOTIFY_EDIT @IDA=" & IDA
            dt = Queryds(qstr)

            Return dt
        End Function
        Public Function SP_XML_TABEAN_NOTIFY_LIST(ByVal IDA As Integer) As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_XML_TABEAN_NOTIFY_LIST @FK_IDA=" & IDA
            dt = Queryds(qstr)

            Return dt
        End Function
        Public Function SP_XML_TABEAN_RENEW_JJ(ByVal FK_IDA As Integer) As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_XML_TABEAN_RENEW_JJ @FK_IDA=" & FK_IDA
            dt = Queryds(qstr)
        ...
        Public Function SP_TABEAN_HERB_BY_FK_IDA_LCN(ByVal IDA_LCN As Integer) As DataTable
            ...
            Return dt
        End Function
        Public Function SP_HERB_REPORT_DETAIL_BY_FK_IDA_LCN(ByVal FK_IDA As Integer) As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_HERB_REPORT_DETAIL_BY_FK_IDA_LCN @IDA=" & FK_IDA
            dt = Queryds(qstr)

            Return dt
        End Function
        Public Function SP_HERB_PRODUCT_NOTIFIED_DETAIL(ByVal FK_IDA As Integer) As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_HERB_PRODUCT_NOTIFIED_DETAIL @IDA=" & FK_IDA
            dt = Queryds(qstr)
        ...
        Public Function SP_TABEAN_INFORM_BY_FK_IDA_LCN_AND_IDEN(ByVal IDA_LCN As Integer, ByVal IDEN As String) As DataTable
            ...
            Return dt
        End Function
        Public Function SP_HERB_PRODUCT_NOTIFIEDT_MAIN_BY_FK_IDA_LCN(ByVal IDA_LCN As Integer, ByVal IDEN As String) As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_HERB_PRODUCT_NOTIFIEDT_MAIN_BY_FK_IDA_LCN @IDA=" & IDA_LCN & ",@IDEN='" & IDEN & "'"
            dt = Queryds(qstr)

            Return dt
        End Function
        Public Function SP_HERB_REPORT_MAIN_BY_FK_IDA_LCN(ByVal IDA_LCN As Integer, ByVal IDEN As String, ByVal PROCESS As String) As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_HERB_REPORT_MAIN_BY_FK_IDA_LCN @IDA=" & IDA_LCN & ",@IDEN='" & IDEN & "'" & ",@PROCESS_ID='" & PROCESS & "'"
            dt = Queryds(qstr)

            Return dt
        End Function
        Public Function SP_TABEAN_INFORM_EDIT_BY_FK_IDA_LCN_AND_IDEN(ByVal IDA_LCN As Integer, ByVal IDEN As String, ByVal FK_IDA As String) As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_TABEAN_INFORM_EDIT_BY_FK_IDA_LCN_AND_IDEN @FK_LCN=" & IDA_LCN & ",@IDEN='" & IDEN & "'" & ",@FK_IDA=" & FK_IDA
            dt = Queryds(qstr)

            Return dt
        End Function
        Public Function SP_TABEAN_INFORM_EDIT_STAFF() As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_TABEAN_INFORM_EDIT_STAFF"
            dt = Queryds(qstr)
        ...
        Public Function SP_TABEAN_INFORM_STAFF() As DataTable
            ...
            Return dt
        End Function
        Public Function SP_TABEAN_HERB_BY_FK_IDA_LCN_AND_CID_WHO(ByVal IDA_LCN As Integer, ByVal CITIZEN As String) As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_TABEAN_HERB_BY_FK_IDA_LCN_AND_CID_WHO @IDA=" & IDA_LCN & ",@CITIZEN_ID='" & CITIZEN & "'"
            dt = Queryds(qstr)

            Return dt
        End Function
        Public Function SP_TABEAN_HERB_BY_FK_IDA_LCN_WHO(ByVal IDA_LCN As Integer, ByVal C_ID As String, ByVal TYPEPERSON As Integer) As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_TABEAN_HERB_BY_FK_IDA_LCN_WHO @IDA=" & IDA_LCN & ",@C_ID=" & C_ID & ",@TYPEPERSON=" & TYPEPERSON
            dt = Queryds(qstr)
        ...
        'Public Function SP_TABEAN_JJ_EDIT_SUB_PACKSIZE(ByVal DD_HERB_NAME_PRODUCT_ID As Integer, ByVal P_ID As Integer) As DataTable
        '    Dim dt As New DataTable
        '    Dim qstr As String = ""

        '    qstr = "exec SP_TABEAN_JJ_EDIT_SUB_PACKSIZE @DD_HERB_NAME_PRODUCT_ID=" & DD_HERB_NAME_PRODUCT_ID & ",@PROCESS_ID=" & P_ID
        '    dt = Queryds(qstr)
        ...
        Public Function SP_TABEAN_LOG_EDIT_DETAIL_BY_IDA_G(ByVal IDA_G As Integer) As DataTable
            ...
            Return dt
        End Function
        Public Function SP_DRRGT_LOG_EDIT_DETAIL_BY_IDA_G(ByVal IDA_G As Integer) As DataTable
            Dim dt As New DataTable
            Dim qstr As String = ""

            qstr = "exec SP_DRRGT_LOG_EDIT_DETAIL_BY_IDA_G @IDA=" & IDA_G
            dt = Queryds(qstr)
