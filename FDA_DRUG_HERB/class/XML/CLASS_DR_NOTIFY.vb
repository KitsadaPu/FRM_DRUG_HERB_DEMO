Public Class CLASS_DR_NOTIFY
    Inherits CLASS_CENTER
    Public TABEAN_NOTIFY_EDIT As New TABEAN_HERB_NOTIFY_CORRECTION
...
#End Region
    ...
    Private _DATE_CREATE_TH As String
    Public Property DATE_CREATE_TH() As String
        Get
            Return _DATE_CREATE_TH
        End Get
        Set(ByVal value As String)
            _DATE_CREATE_TH = value
        End Set
    End Property
