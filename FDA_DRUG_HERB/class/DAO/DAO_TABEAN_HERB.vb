Namespace DAO_TABEAN_HERB
    ...
    Public Class TB_TABEAN_JJ_EDIT_SUBPACKAGE
        ...
        Public Sub GetData_ByFkIDA(ByVal fk_ida As Integer)
            datas = (From p In db.TABEAN_JJ_EDIT_SUB_PACKSIZEs Where p.FK_IDA = fk_ida Select p)
            For Each Me.fields In datas
                AddDetails()
            Next
        End Sub
    ...
    Public Class TB_MAS_TABEAN_HERB_STATUS_JJ
        ...
        End Sub
    End Class
    Public Class TB_MAS_TABEAN_HERB_NEW_STATUS
        Inherits MAINCONTEXT

        Public fields As New MAS_TABEAN_HERB_NEW_STATUS

        Public Sub insert()
            db.MAS_TABEAN_HERB_NEW_STATUS.InsertOnSubmit(fields)
            db.SubmitChanges()
        End Sub
        ...
        Public Sub Delete()
            db.MAS_TABEAN_HERB_NEW_STATUS.DeleteOnSubmit(fields)
            db.SubmitChanges()
        End Sub

        Public Sub GetAll()
            datas = (From p In db.MAS_TABEAN_HERB_NEW_STATUS Select p)

        End Sub

        Public Sub GetdatabyID_IDA(ByVal IDA As Integer)
            datas = From p In db.MAS_TABEAN_HERB_NEW_STATUS Where p.IDA = IDA Select p
        ...
        Public Sub Getdataby_STATUS_ID(ByVal S_ID As Integer)
            datas = From p In db.MAS_TABEAN_HERB_NEW_STATUS Where p.STATUS_ID = S_ID Select p
        ...
        End Sub
        Public Sub Getdataby_STATUS_ID_GROUP(ByVal S_ID As Integer, ByVal G_ID As Integer)
            datas = From p In db.MAS_TABEAN_HERB_NEW_STATUS Where p.STATUS_ID = S_ID And p.STATUS_GROUP = G_ID Select p
            For Each Me.fields In datas
    ...
    Public Class TB_TABEAN_HERB_EDIT_REQUEST
        ...
        End Sub
        Public Sub GetdatabyID_TR_ID(ByVal TR_ID As Integer)
            datas = From p In db.TABEAN_HERB_EDIT_REQUESTs Where p.TR_ID = TR_ID Select p
    ...
    Public Class TB_TABEAN_HERB_EDIT_MANUFACTRUE
        ...
        Public Sub GetdatabyID_FK_IDA_DQ(ByVal FK_IDA As Integer)
            ...
            Next
        End Sub
        Public Sub GetdatabyID_FK_IDA_BY_MENUFAC(ByVal FK_IDA As Integer)
            datas = From p In db.TABEAN_HERB_EDIT_MANUFACTRUEs Where p.FK_IDA = FK_IDA And p.ACTIVEFACT = 1 Select p Order By p.MENUFAC_ID Ascending
    ...
    Public Class TB_GEN_NO_TBN_FronNarcotic
        ...
        Public Sub GetDataby_RGTTPCD_MAX(ByVal YEAR As String, ByVal RGTTPCD As String, ByVal drgtpcd As Integer)
            ...
            Next
        End Sub
        Public Sub GetDataby_Condition_MAX(ByVal YEAR As String, ByVal RGTTPCD As String, ByVal drgtpcd As String, ByVal Condition As Integer)
            'datas = (From p In db.GEN_NO_01s Where p.IDA = YEAR Order By p.IDA Descending Select p)
    ...
    End Class
    Public Class TB_TABEAN_TRANSFER
        Inherits MAINCONTEXT

        Public fields As New TABEAN_HERB_TRANSFER

        Public Sub insert()
            db.TABEAN_HERB_TRANSFERs.InsertOnSubmit(fields)
            db.SubmitChanges()
        End Sub
        ...
        Public Sub Delete()
            db.TABEAN_HERB_TRANSFERs.DeleteOnSubmit(fields)
            db.SubmitChanges()
        End Sub

        Public Sub GetAll()
            datas = (From p In db.TABEAN_HERB_TRANSFERs Select p)

        End Sub

        Public Sub GetdatabyID_IDA(ByVal IDA As Integer)
            datas = From p In db.TABEAN_HERB_TRANSFERs Where p.IDA = IDA Select p
        ...
        End Sub
        Public Sub GetdatabyID_FK_IDA(ByVal FK_IDA As Integer)
            datas = From p In db.TABEAN_HERB_TRANSFERs Where p.FK_IDA = FK_IDA Select p
            For Each Me.fields In datas
            Next
        End Sub

    End Class
    Public Class TB_TABEAN_NOTIFY
        Inherits MAINCONTEXT

        Public fields As New TABEAN_HERB_NOTIFY_CORRECTION

        Public Sub insert()
            db.TABEAN_HERB_NOTIFY_CORRECTIONs.InsertOnSubmit(fields)
            db.SubmitChanges()
        End Sub
        ...
        Public Sub Delete()
            db.TABEAN_HERB_NOTIFY_CORRECTIONs.DeleteOnSubmit(fields)
            db.SubmitChanges()
        End Sub

        Public Sub GetAll()
            datas = (From p In db.TABEAN_HERB_NOTIFY_CORRECTIONs Select p)

        End Sub

        Public Sub GetdatabyID_IDA(ByVal IDA As Integer)
            datas = From p In db.TABEAN_HERB_NOTIFY_CORRECTIONs Where p.IDA = IDA Select p
        ...
        End Sub
        Public Sub GetdatabyID_FK_IDA(ByVal FK_IDA As Integer)
            datas = From p In db.TABEAN_HERB_NOTIFY_CORRECTIONs Where p.FK_IDA = FK_IDA Select p
            For Each Me.fields In datas
            Next
        End Sub

    End Class
    Public Class TB_TABEAN_NOTIFY_LIST
        Inherits MAINCONTEXT

        Public fields As New TABEAN_HERB_NOTIFY_CORRECTION_LIST

        Public Sub insert()
            db.TABEAN_HERB_NOTIFY_CORRECTION_LISTs.InsertOnSubmit(fields)
            db.SubmitChanges()
        End Sub
        ...
        Public Sub Delete()
            db.TABEAN_HERB_NOTIFY_CORRECTION_LISTs.DeleteOnSubmit(fields)
            db.SubmitChanges()
        End Sub

        Public Sub GetAll()
            datas = (From p In db.TABEAN_HERB_NOTIFY_CORRECTION_LISTs Select p)

        End Sub

        Public Sub GetdatabyID_IDA(ByVal IDA As Integer)
            datas = From p In db.TABEAN_HERB_NOTIFY_CORRECTION_LISTs Where p.IDA = IDA Select p
        ...
        End Sub
        Public Sub GetdatabyID_FK_IDA(ByVal FK_IDA As Integer)
            datas = From p In db.TABEAN_HERB_NOTIFY_CORRECTION_LISTs Where p.FK_IDA = FK_IDA Select p
            For Each Me.fields In datas
            Next
        End Sub

    End Class
    Public Class TB_TABEAN_NOTIFY_LIST_EDIT
        Inherits MAINCONTEXT

        Public fields As New TABEAN_HERB_NOTIFY_CORRECTION_LIST_EDIT

        Public Sub insert()
            db.TABEAN_HERB_NOTIFY_CORRECTION_LIST_EDITs.InsertOnSubmit(fields)
            db.SubmitChanges()
        End Sub
        ...
        Public Sub Delete()
            db.TABEAN_HERB_NOTIFY_CORRECTION_LIST_EDITs.DeleteOnSubmit(fields)
            db.SubmitChanges()
        End Sub

        Public Sub GetAll()
            datas = (From p In db.TABEAN_HERB_NOTIFY_CORRECTION_LIST_EDITs Select p)

        End Sub

        Public Sub GetdatabyID_IDA(ByVal IDA As Integer)
            datas = From p In db.TABEAN_HERB_NOTIFY_CORRECTION_LIST_EDITs Where p.IDA = IDA Select p
        ...
        End Sub
        Public Sub GetdatabyID_FK_IDA(ByVal FK_IDA As Integer)
            datas = From p In db.TABEAN_HERB_NOTIFY_CORRECTION_LIST_EDITs Where p.FK_IDA = FK_IDA Select p
            For Each Me.fields In datas
            Next
        End Sub
    ...
    Public Class TB_TABEAN_EDIT_EACH
        ...
        End Function
    End Class
    Public Class TB_LOG_EMAIL
        Inherits MAINCONTEXT

        Public fields As New LOG_EMAIL

        Public Sub insert()
            db.LOG_EMAILs.InsertOnSubmit(fields)
            db.SubmitChanges()
        End Sub
        ...
        Public Sub Delete()
            db.LOG_EMAILs.DeleteOnSubmit(fields)
            db.SubmitChanges()
        End Sub

        Public Sub GetAll()
            datas = (From p In db.LOG_EMAILs Select p)

        End Sub

        Public Sub GetdatabyID_IDA(ByVal IDA As Integer)
            datas = From p In db.LOG_EMAILs Where p.IDA = IDA Select p
    ...
    Public Class TB_TABEAN_EDIT_REQUEST_EQTO_OLD
        ...
        Public Sub GetDataby_IDA(ByVal IDA As Integer)
            ...
            datas = (From p In db.TABEAN_EDIT_REQUEST_EQTO_OLDs Where p.IDA = IDA Select p)
            For Each Me.fields In datas
