...
Public Class FRM_HERB_TABEAN_EX_STAFF_APPROVE
    ...
    Public Sub bind_data()
        ...
        'End Try
        TXT_POSITION_STAFF.Text = dao.fields.POSITION_STAFF_APPROVE_NAME
    ...
    Public Sub GEN_Pdf_Tabean_Herb_EX()
        Dim bao_app As New BAO.AppSettings
        bao_app.RunAppSettings()
    ...
    Sub xml(ByVal drsamp_ida As Integer)
        ...
        Dim CITIZEN_ID As String = dao_drsamp.fields.CUSTOMER_CITIZEN_AUTHORIZE
        'Dim cls As New CLS_COMMON.convert
        Dim result As String = ""
        'result = ws_center.GET_DATA_IDEM(citizen_id, citizen_id, "IDEM", "DPIS")
        cls_xml.DT_SHOW.DT10 = ws_center.GET_DATA_IDENTIFY_DT(CITIZEN_ID, CITIZEN_ID, "DT10", "FUSION", "P@ssw0rdfusion440")
        'cls_xml.DT_SHOW.DT10 = bao_show.SP_MAINPERSON_CTZNO(_CLS.CITIZEN_ID) 'ผู้ยื่น
        Try
