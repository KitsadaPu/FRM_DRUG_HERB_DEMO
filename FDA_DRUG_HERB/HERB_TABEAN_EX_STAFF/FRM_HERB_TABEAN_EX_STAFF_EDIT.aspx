...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-lg-5" style="padding-left: 4em">
            ...
            <asp:Label ID="lbl_tb1_edit" runat="server" Text="แก้ไข ข้อมูลคำขอ"></asp:Label>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-5"></div>
        <div class="col-lg-5" style="padding-left: 4em">
            ...
            <asp:Label ID="lbl_upload_edit" runat="server" Text="แก้ไข เอกสารเอกสารแนบ"></asp:Label>
        </div>
    </div>
